...
// It seems starting from MSVC 16.10 std::less() marked as [[nodiscard]], but we pass it eventually to boost/concept_check.hpp:355, which ignores a return value.
// So have to disable it for now.
