...
DECLARE_PMID(kClassIDSpace, kQAPublishOnlineEngTestSuiteTestProviderBoss,		kTestingPrefix + 216)
DECLARE_PMID(kClassIDSpace, kQAPublishOnlineBenchmarkTestProviderBoss,		kTestingPrefix + 217)
DECLARE_PMID(kClassIDSpace, kQAUXPTestProviderBoss,                 kTestingPrefix + 218)
...
DECLARE_PMID(kImplementationIDSpace, kQAPublishOnlineEngTestSuiteTestProviderImpl,	kTestingPrefixE + 26)
DECLARE_PMID(kImplementationIDSpace, kQAPublishOnlineBenchmarkTestProviderImpl, kTestingPrefixE + 27)
DECLARE_PMID(kImplementationIDSpace, kQAUXPTestProviderImpl,            kTestingPrefixE + 28)
// <Ignore>
