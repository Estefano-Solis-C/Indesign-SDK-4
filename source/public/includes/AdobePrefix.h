...
const int32 kLastAdobePrefix = 0x402;
...
//							{0x00,"UNUSED_PREFIX"},							// Unused
							...
							{0x240, "kCollaborationPrefix"},
							{0x241, "kCloudDocsPrefix"},
							{0x242, "kHEIFFilterPrefix"},
							{0x243, "kWEBPFilterPrefix"},
							{0x244, "kJP2KFilterPrefix"},
							{0x245, "kGenAIPrefix"},
							{0x246, "AppUI 3rd prefix"},
							{0x247, "kHistoryPanelPrefix"},
							...
							{0x3fe,"XScriptPrefix"},
							{0x3ff,"AutoUIPrefix"},
							{0x400,"TestPrivateHeadersPrefix"},
