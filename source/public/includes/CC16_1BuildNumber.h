...
#ifndef __CC16_1BuildNumber_h__
#define __CC16_1BuildNumber_h__
...
//
#define kCC16_1VersionNumber 16.1
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC16_1VersionNumberStr "16.1"
...
//		2. Update kCC16_1VersionNumberForResourceStr
//		3. Update kCC16_1VersionCopyRightStr for the Mac
//		4. Update kCC16_1CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC16_1AUMComponentVersionStr
// 
...
#define CC16_1_DOT_RELEASE_NUMBER 0

#if CC16_1_DOT_RELEASE_NUMBER
#define kCC16_1VersionNumberForResourceStr "16.1.1"
#else
#define kCC16_1VersionNumberForResourceStr "16.1"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC16_1MajorVersionNumber RezLong(16)
#define kCC16_1MinorVersionNumber RezLong(1)
#define kCC16_1DotVersionNumber  RezLong(CC16_1_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC16_1MajorVersionNumberForResource 16
#define kCC16_1MinorVersionNumberForResource 1
#define kCC16_1DotVersionNumberForResource CC16_1_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC16_1_DOT_RELEASE_NUMBER
#define kCC16_1VersionCopyRightStr "16.1.1, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_1CFBundleVersionStr "16110"
#else
#define kCC16_1VersionCopyRightStr "16.1, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_1CFBundleVersionStr "16100"
#endif
#endif

#ifdef WINDOWS
#define kCC16_1VersionCopyRightStr "Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_1ShortCopyRightStr "Copyright 1999-2021 Adobe."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC16_1_DOT_RELEASE_NUMBER
#define kCC16_1AUMComponentVersionStr	"16.1.1."
#else
#define kCC16_1AUMComponentVersionStr	"16.1.0."
#endif
// ----- Version string for Adobe Crash Reporter
#if CC16_1_DOT_RELEASE_NUMBER
#define kCC16_1CRAdobeProductVersionStr	"16110"
#else
#define kCC16_1CRAdobeProductVersionStr	"16100"
#endif

// ----- Display name for Adobe Crash Reporter
#define kCC16_1CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2021"
#define kCC16_1CRAdobeInCopyDisplayNameStr	"Adobe InCopy 2021"
...
#define kCC16_1MajorScriptVersionNumber	RezLong(16)
#define kCC16_1MinorScriptVersionNumber	RezLong(1)
