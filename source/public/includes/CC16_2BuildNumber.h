...
#ifndef __CC16_2BuildNumber_h__
#define __CC16_2BuildNumber_h__
...
//
#define kCC16_2VersionNumber 16.2
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC16_2VersionNumberStr "16.2"
...
//		2. Update kCC16_2VersionNumberForResourceStr
//		3. Update kCC16_2VersionCopyRightStr for the Mac
//		4. Update kCC16_2CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC16_2AUMComponentVersionStr
// 
...
#define CC16_2_DOT_RELEASE_NUMBER 1

#if CC16_2_DOT_RELEASE_NUMBER
#define kCC16_2VersionNumberForResourceStr "16.2.1"
#else
#define kCC16_2VersionNumberForResourceStr "16.2"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC16_2MajorVersionNumber RezLong(16)
#define kCC16_2MinorVersionNumber RezLong(2)
#define kCC16_2DotVersionNumber  RezLong(CC16_2_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC16_2MajorVersionNumberForResource 16
#define kCC16_2MinorVersionNumberForResource 2
#define kCC16_2DotVersionNumberForResource CC16_2_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC16_2_DOT_RELEASE_NUMBER
#define kCC16_2VersionCopyRightStr "16.2.1, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_2CFBundleVersionStr "16210"
#else
#define kCC16_2VersionCopyRightStr "16.2, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_2CFBundleVersionStr "16200"
#endif
#endif

#ifdef WINDOWS
#define kCC16_2VersionCopyRightStr "Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_2ShortCopyRightStr "\xa9 1999-2021 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC16_2_DOT_RELEASE_NUMBER
#define kCC16_2AUMComponentVersionStr	"16.2.1."
#else
#define kCC16_2AUMComponentVersionStr	"16.2.0."
#endif
// ----- Version string for Adobe Crash Reporter
#if CC16_2_DOT_RELEASE_NUMBER
#define kCC16_2CRAdobeProductVersionStr	"16210"
#else
#define kCC16_2CRAdobeProductVersionStr	"16200"
#endif

// ----- Display name for Adobe Crash Reporter
#define kCC16_2CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2021"
#define kCC16_2CRAdobeInCopyDisplayNameStr	"Adobe InCopy 2021"
...
#define kCC16_2MajorScriptVersionNumber	RezLong(16)
#define kCC16_2MinorScriptVersionNumber	RezLong(2)
