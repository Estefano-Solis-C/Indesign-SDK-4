...
#ifndef __CC16_3BuildNumber_h__
#define __CC16_3BuildNumber_h__
...
//
#define kCC16_3VersionNumber 16.3
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC16_3VersionNumberStr "16.3"
...
//
#ifdef BETA_BUILD
#define kCC16_3UIVersionStr "2021 (Beta)"
#elif PRERELEASE_BUILD
#define kCC16_3UIVersionStr "2021 (Prerelease)"
#else
#define kCC16_3UIVersionStr "2021"
#endif
...
//		2. Update kCC16_3VersionNumberForResourceStr
//		3. Update kCC16_3VersionCopyRightStr for the Mac
//		4. Update kCC16_3CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC16_3AUMComponentVersionStr
// 
...
#define CC16_3_DOT_RELEASE_NUMBER 0

#if CC16_3_DOT_RELEASE_NUMBER
#define kCC16_3VersionNumberForResourceStr "16.3.1"
#else
#define kCC16_3VersionNumberForResourceStr "16.3"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC16_3MajorVersionNumber RezLong(16)
#define kCC16_3MinorVersionNumber RezLong(3)
#define kCC16_3DotVersionNumber  RezLong(CC16_3_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC16_3MajorVersionNumberForResource 16
#define kCC16_3MinorVersionNumberForResource 3
#define kCC16_3DotVersionNumberForResource CC16_3_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC16_3_DOT_RELEASE_NUMBER
#define kCC16_3VersionCopyRightStr "16.3.1, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_3CFBundleVersionStr "16310"
#else
#define kCC16_3VersionCopyRightStr "16.3, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_3CFBundleVersionStr "16300"
#endif
#ifdef BETA_BUILD
#define kCC16_3CFBundleNameStr "InDesign (Beta)"
#define kCC16_3InCopyCFBundleNameStr "InCopy (Beta)"
#elif PRERELEASE_BUILD
#define kCC16_3CFBundleNameStr "InDesign (Prerelease)"
#define kCC16_3InCopyCFBundleNameStr "InCopy (Prerelease)"
#else
#define kCC16_3CFBundleNameStr "InDesign"
#define kCC16_3InCopyCFBundleNameStr "InCopy"
#endif
#endif

#ifdef WINDOWS
#define kCC16_3VersionCopyRightStr "Copyright 1999-2021 Adobe. All rights reserved."
#define kCC16_3ShortCopyRightStr "\xa9 1999-2021 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC16_3_DOT_RELEASE_NUMBER
#define kCC16_3AUMComponentVersionStr	"16.3.1."
#else
#define kCC16_3AUMComponentVersionStr	"16.3.0."
#endif
// ----- Version string for Adobe Crash Reporter
#if CC16_3_DOT_RELEASE_NUMBER
#define kCC16_3CRAdobeProductVersionStr	"16310"
#else
#define kCC16_3CRAdobeProductVersionStr	"16300"
#endif

// ----- Display name for Adobe Crash Reporter
#define kCC16_3CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2021"
#define kCC16_3CRAdobeInCopyDisplayNameStr	"Adobe InCopy 2021"
...
#define kCC16_3MajorScriptVersionNumber	RezLong(16)
#define kCC16_3MinorScriptVersionNumber	RezLong(3)
