...
#ifndef __CC17BuildNumber_h__
#define __CC17BuildNumber_h__
...
//
#define kCC17VersionNumber 17.0
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17VersionNumberStr "17.0"
...
//
#ifdef BETA_BUILD
#define kCC17UIVersionStr "2022 (Beta)"
#elif PRERELEASE_BUILD
#define kCC17UIVersionStr "2022 (Prerelease)"
#else
#define kCC17UIVersionStr "2022"
#endif
...
//
#define CC17_DOT_RELEASE_NUMBER 1

#if CC17_DOT_RELEASE_NUMBER
#define kCC17VersionNumberForResourceStr "17.0.1"
#else
#define kCC17VersionNumberForResourceStr "17.0"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC17MajorVersionNumber RezLong(17)
#define kCC17MinorVersionNumber RezLong(0)
#define kCC17DotVersionNumber RezLong(CC17_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC17MajorVersionNumberForResource 17
#define kCC17MinorVersionNumberForResource 0
#define kCC17DotVersionNumberForResource CC17_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC17_DOT_RELEASE_NUMBER
#define kCC17VersionCopyRightStr "17.0.1, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC17CFBundleVersionStr "17010"
#else
#define kCC17VersionCopyRightStr "17.0, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC17CFBundleVersionStr "17000"
#endif
#endif

#ifdef WINDOWS
#define kCC17VersionCopyRightStr "Copyright 1999-2021 Adobe. All rights reserved."
#define kCC17ShortCopyRightStr "\xa9 1999-2021 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC17_DOT_RELEASE_NUMBER
#define kCC17AUMComponentVersionStr	"17.0.1."
#else
#define kCC17AUMComponentVersionStr	"17.0.0."
#endif

// ----- Version string for Adobe Crash Reporter
#if CC17_DOT_RELEASE_NUMBER
#define kCC17CRAdobeProductVersionStr "17010"
#else
#define kCC17CRAdobeProductVersionStr "17000"
#endif

#define kCC17CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2022"
#define kCC17CRAdobeInCopyDisplayNameStr    "(Adobe InCopy 2022)"
...
#define kCC17MajorScriptVersionNumber	RezLong(17)
#define kCC17MinorScriptVersionNumber	RezLong(0)
