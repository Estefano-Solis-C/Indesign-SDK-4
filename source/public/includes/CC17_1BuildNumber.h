...
#ifndef __CC17_1BuildNumber_h__
#define __CC17_1BuildNumber_h__
...
//
#define kCC17_1VersionNumber 17.1
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_1VersionNumberStr "17.1"
...
//
#ifdef BETA_BUILD
#define kCC17_1UIVersionStr "2022 (Beta)"
#elif PRERELEASE_BUILD
#define kCC17_1UIVersionStr "2022 (Prerelease)"
#else
#define kCC17_1UIVersionStr "2022"
#endif
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_1CCVersionYearBasedHandleStr "2022"

// ----- This represents year based full version handle of the product to
//		 be presented to the user in about screen.
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_1CCVersionYearBasedFullHandleStr "2022.1"


// ----- CC17_1_DOT_RELEASE_NUMBER represents the product dot
//		release version.
...
//		1. Change CC17_1_DOT_RELEASE_NUMBER to non-zero
...
//
#define CC17_1_DOT_RELEASE_NUMBER 0

#if CC17_1_DOT_RELEASE_NUMBER
#define kCC17_1VersionNumberForResourceStr "17.1.0"
#else
#define kCC17_1VersionNumberForResourceStr "17.1"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC17_1MajorVersionNumber RezLong(17)
#define kCC17_1MinorVersionNumber RezLong(1)
#define kCC17_1DotVersionNumber RezLong(CC17_1_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC17_1MajorVersionNumberForResource 17
#define kCC17_1MinorVersionNumberForResource 1
#define kCC17_1DotVersionNumberForResource CC17_1_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC17_1_DOT_RELEASE_NUMBER
#define kCC17_1VersionCopyRightStr "17.1.0, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC17_1CFBundleVersionStr "17100"
#else
#define kCC17_1VersionCopyRightStr "17.1, Copyright 1999-2021 Adobe. All rights reserved."
#define kCC17_1CFBundleVersionStr "17100"
#endif
#ifdef BETA_BUILD
#define kCC17_1CFBundleNameStr "InDesign (Beta)"
#define kCC17_1InCopyCFBundleNameStr "InCopy (Beta)"
#elif PRERELEASE_BUILD
#define kCC17_1CFBundleNameStr "InDesign (Prerelease)"
#define kCC17_1InCopyCFBundleNameStr "InCopy (Prerelease)"
#else
#define kCC17_1CFBundleNameStr "InDesign"
#define kCC17_1InCopyCFBundleNameStr "InCopy"
#endif
#endif

#ifdef WINDOWS
#define kCC17_1VersionCopyRightStr "Copyright 1999-2021 Adobe. All rights reserved."
#define kCC17_1ShortCopyRightStr "\xa9 1999-2021 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC17_1_DOT_RELEASE_NUMBER
#define kCC17_1AUMComponentVersionStr	"17.1.0"
#else
#define kCC17_1AUMComponentVersionStr	"17.1.0."
#endif
...
#if CC17_1_DOT_RELEASE_NUMBER
#define kCC17_1CRAdobeProductVersionStr "17100"
#else
#define kCC17_1CRAdobeProductVersionStr "17100"
#endif

#define kCC17_1CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2022"
#define kCC17_1CRAdobeInCopyDisplayNameStr    "(Adobe InCopy 2022)"
...
#define kCC17_1MajorScriptVersionNumber	RezLong(17)
#define kCC17_1MinorScriptVersionNumber	RezLong(1)
