...
#ifndef __CC17_2BuildNumber_h__
#define __CC17_2BuildNumber_h__
...
//
#define kCC17_2VersionNumber 17.2
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_2VersionNumberStr "17.2"
...
//
#ifdef BETA_BUILD
#define kCC17_2UIVersionStr "2022 (Beta)"
#elif PRERELEASE_BUILD
#define kCC17_2UIVersionStr "2022 (Prerelease)"
#else
#define kCC17_2UIVersionStr "2022"
#endif
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_2CCVersionYearBasedHandleStr "2022"

// ----- This represents year based full version handle of the product to
//		 be presented to the user in about screen.
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_2CCVersionYearBasedFullHandleStr "2022.1"


// ----- CC17_2_DOT_RELEASE_NUMBER represents the product dot
//		release version.
...
//		1. Change CC17_2_DOT_RELEASE_NUMBER to non-zero
...
//
#define CC17_2_DOT_RELEASE_NUMBER 0

#if CC17_2_DOT_RELEASE_NUMBER
#define kCC17_2VersionNumberForResourceStr "17.2.0"
#else
#define kCC17_2VersionNumberForResourceStr "17.2"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC17_2MajorVersionNumber RezLong(17)
#define kCC17_2MinorVersionNumber RezLong(2)
#define kCC17_2DotVersionNumber RezLong(CC17_2_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC17_2MajorVersionNumberForResource 17
#define kCC17_2MinorVersionNumberForResource 2
#define kCC17_2DotVersionNumberForResource CC17_2_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC17_2_DOT_RELEASE_NUMBER
#define kCC17_2VersionCopyRightStr "17.2.0, Copyright 1999-2022 Adobe. All rights reserved."
#define kCC17_2CFBundleVersionStr "17200"
#else
#define kCC17_2VersionCopyRightStr "17.2, Copyright 1999-2022 Adobe. All rights reserved."
#define kCC17_2CFBundleVersionStr "17200"
#endif
#ifdef BETA_BUILD
#define kCC17_2CFBundleNameStr "InDesign (Beta)"
#define kCC17_2InCopyCFBundleNameStr "InCopy (Beta)"
#elif PRERELEASE_BUILD
#define kCC17_2CFBundleNameStr "InDesign (Prerelease)"
#define kCC17_2InCopyCFBundleNameStr "InCopy (Prerelease)"
#else
#define kCC17_2CFBundleNameStr "InDesign"
#define kCC17_2InCopyCFBundleNameStr "InCopy"
#endif
#endif

#ifdef WINDOWS
#define kCC17_2VersionCopyRightStr "Copyright 1999-2022 Adobe. All rights reserved."
#define kCC17_2ShortCopyRightStr "\xa9 1999-2022 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC17_2_DOT_RELEASE_NUMBER
#define kCC17_2AUMComponentVersionStr	"17.2.1."
#else
#define kCC17_2AUMComponentVersionStr	"17.2.0."
#endif

// ----- Version string for Adobe Crash Reporter
#if CC17_2_DOT_RELEASE_NUMBER
#define kCC17_2CRAdobeProductVersionStr "17200"
#else
#define kCC17_2CRAdobeProductVersionStr "17200"
#endif

#define kCC17_2CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2022"
#define kCC17_2CRAdobeInCopyDisplayNameStr    "(Adobe InCopy 2022)"
...
#define kCC17_2MajorScriptVersionNumber	RezLong(17)
#define kCC17_2MinorScriptVersionNumber	RezLong(2)
