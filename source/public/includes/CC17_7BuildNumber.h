...
#ifndef __CC17_7BuildNumber_h__
#define __CC17_7BuildNumber_h__
...
//
#define kCC17_7VersionNumber 17.7
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_7VersionNumberStr "17.7"
...
//
#ifdef BETA_BUILD
#define kCC17_7UIVersionStr "2022 (Beta)"
#elif PRERELEASE_BUILD
#define kCC17_7UIVersionStr "2022 (Prerelease)"
#else
#define kCC17_7UIVersionStr "2022"
#endif
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_7CCVersionYearBasedHandleStr "2022"

// ----- This represents year based full version handle of the product to
//		 be presented to the user in about screen.
// ----- This DOES NOT change when we have a dot release
//
#define kCC17_7CCVersionYearBasedFullHandleStr "2022.7"


// ----- CC17_DOT_RELEASE_NUMBER represents the product dot
//		release version.
...
//		1. Change CC17_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kCC17_7VersionNumberForResourceStr
//		3. Update kCC17_7VersionCopyRightStr for the Mac
//		4. Update kCC17_7CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC17_7AUMComponentVersionStr
//		6. Update kCC17_7CRAdobeProductVersionStr similar to kCC17CFBundleVersionStr
// 
...
//
#define CC17_7_DOT_RELEASE_NUMBER 2

#if CC17_7_DOT_RELEASE_NUMBER
#define kCC17_7VersionNumberForResourceStr "17.7.2"
#else
#define kCC17_7VersionNumberForResourceStr "17.7"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC17_7MajorVersionNumber RezLong(17)
#define kCC17_7MinorVersionNumber RezLong(7)
#define kCC17_7DotVersionNumber RezLong(CC17_7_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC17_7MajorVersionNumberForResource 17
#define kCC17_7MinorVersionNumberForResource 7
#define kCC17_7DotVersionNumberForResource CC17_7_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC17_7_DOT_RELEASE_NUMBER
#define kCC17_7VersionCopyRightStr "17.7.2, Copyright 1999-2022 Adobe. All rights reserved."
#define kCC17_7CFBundleVersionStr "17720"
#else
#define kCC17_7VersionCopyRightStr "17.7, Copyright 1999-2022 Adobe. All rights reserved."
#define kCC17_7CFBundleVersionStr "17700"
#endif
#endif

#ifdef WINDOWS
#define kCC17_7VersionCopyRightStr "Copyright 1999-2022 Adobe. All rights reserved."
#define kCC17_7ShortCopyRightStr "\xa9 1999-2022 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC17_7_DOT_RELEASE_NUMBER
#define kCC17_7AUMComponentVersionStr	"17.7.2."
#else
#define kCC17_7AUMComponentVersionStr	"17.7.0."
#endif

// ----- Version string for Adobe Crash Reporter
#if CC17_7_DOT_RELEASE_NUMBER
#define kCC17_7CRAdobeProductVersionStr "17720"
#else
#define kCC17_7CRAdobeProductVersionStr "17700"
#endif

#define kCC17_7CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2022"
#define kCC17_7CRAdobeInCopyDisplayNameStr    "(Adobe InCopy 2022)"
...
#define kCC17_7MajorScriptVersionNumber	RezLong(17)
#define kCC17_7MinorScriptVersionNumber	RezLong(7)
/* USE CLASS IDS from cc17.0 file
#ifdef BETA_BUILD
