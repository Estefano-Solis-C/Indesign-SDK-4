...
#ifndef __CC18BuildNumber_h__
#define __CC18BuildNumber_h__
...
//
#define kCC18VersionNumber 18.0
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC18VersionNumberStr "18.0"
...
//
#ifdef BETA_BUILD
#define kCC18UIVersionStr "2023 (Beta)"
#elif PRERELEASE_BUILD
#define kCC18UIVersionStr "2023 (Prerelease)"
#else
#define kCC18UIVersionStr "2023"
#endif
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC18CCVersionYearBasedHandleStr "2023"

// ----- This represents year based full version handle of the product to
//		 be presented to the user in about screen.
// ----- This DOES NOT change when we have a dot release
//
#define kCC18CCVersionYearBasedFullHandleStr "2023.0"


// ----- CC18_DOT_RELEASE_NUMBER represents the product dot
//		release version.
...
//		1. Change CC18_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kCC18VersionNumberForResourceStr
//		3. Update kCC18VersionCopyRightStr for the Mac
//		4. Update kCC18CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC18AUMComponentVersionStr
//		6. Update kCC18CRAdobeProductVersionStr similar to kCC18CFBundleVersionStr
// 
...
//
#define CC18_DOT_RELEASE_NUMBER 0

#if CC18_DOT_RELEASE_NUMBER
#define kCC18VersionNumberForResourceStr "18.0.0"
#else
#define kCC18VersionNumberForResourceStr "18.0"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC18MajorVersionNumber RezLong(18)
#define kCC18MinorVersionNumber RezLong(0)
#define kCC18DotVersionNumber RezLong(CC18_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC18MajorVersionNumberForResource 18
#define kCC18MinorVersionNumberForResource 0
#define kCC18DotVersionNumberForResource CC18_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC18_DOT_RELEASE_NUMBER
#define kCC18VersionCopyRightStr "18.0.0, Copyright 1999-2022 Adobe Inc. All rights reserved."
#define kCC18CFBundleVersionStr "18000"
#else
#define kCC18VersionCopyRightStr "18.0, Copyright 1999-2022 Adobe Inc. All rights reserved."
#define kCC18CFBundleVersionStr "18000"
#endif
#endif

#ifdef WINDOWS
#define kCC18VersionCopyRightStr "Copyright 1999-2022 Adobe. All rights reserved."
#define kCC18ShortCopyRightStr "\xa9 1999-2022 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC18_DOT_RELEASE_NUMBER
#define kCC18AUMComponentVersionStr	"18.0.0."
#else
#define kCC18AUMComponentVersionStr	"18.0.0."
#endif
...
#if CC18_DOT_RELEASE_NUMBER
#define kCC18CRAdobeProductVersionStr "18000"
#else
#define kCC18CRAdobeProductVersionStr "18000"
#endif

#define kCC18CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2023"
#define kCC18CRAdobeInCopyDisplayNameStr    "(Adobe InCopy 2023)"
...
#define kCC18MajorScriptVersionNumber	RezLong(18)
#define kCC18MinorScriptVersionNumber	RezLong(0)
