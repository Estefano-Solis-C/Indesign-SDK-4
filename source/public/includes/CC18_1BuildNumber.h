...
#ifndef __CC18_1BuildNumber_h__
#define __CC18_1BuildNumber_h__
...
//
#define kCC18_1VersionNumber 18.1
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC18_1VersionNumberStr "18.1"
...
//
#ifdef BETA_BUILD
#define kCC18_1UIVersionStr "2023 (Beta)"
#elif PRERELEASE_BUILD
#define kCC18_1UIVersionStr "2023 (Prerelease)"
#else
#define kCC18_1UIVersionStr "2023"
#endif
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC18_1CCVersionYearBasedHandleStr "2023"

// ----- This represents year based full version handle of the product to
//		 be presented to the user in about screen.
// ----- This DOES NOT change when we have a dot release
//
#define kCC18_1CCVersionYearBasedFullHandleStr "2023.1"


// ----- CC18_1_DOT_RELEASE_NUMBER represents the product dot
//		release version.
...
//		1. Change CC18_1_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kCC18_1VersionNumberForResourceStr
//		3. Update kCC18_1VersionCopyRightStr for the Mac
//		4. Update kCC18_1CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC18_1AUMComponentVersionStr
//		6. Update kCC18_1CRAdobeProductVersionStr similar to kCC18_1CFBundleVersionStr
// 
...
//
#define CC18_1_DOT_RELEASE_NUMBER 0

#if CC18_1_DOT_RELEASE_NUMBER
#define kCC18_1VersionNumberForResourceStr "18.1.1"
#else
#define kCC18_1VersionNumberForResourceStr "18.1"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC18_1MajorVersionNumber RezLong(18)
#define kCC18_1MinorVersionNumber RezLong(1)
#define kCC18_1DotVersionNumber RezLong(CC18_1_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources. 
#define kCC18_1MajorVersionNumberForResource 18
#define kCC18_1MinorVersionNumberForResource 1
#define kCC18_1DotVersionNumberForResource CC18_1_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC18_1_DOT_RELEASE_NUMBER
#define kCC18_1VersionCopyRightStr "18.1.1, Copyright 1999-2022 Adobe Inc. All rights reserved."
#define kCC18_1CFBundleVersionStr "18101"
#else
#define kCC18_1VersionCopyRightStr "18.1, Copyright 1999-2022 Adobe Inc. All rights reserved."
#define kCC18_1CFBundleVersionStr "18100"
#endif
#endif

#ifdef WINDOWS
#define kCC18_1VersionCopyRightStr "Copyright 1999-2022 Adobe. All rights reserved."
#define kCC18_1ShortCopyRightStr "\xa9 1999-2022 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC18_1_DOT_RELEASE_NUMBER
#define kCC18_1AUMComponentVersionStr	"18.1.1."
#else
#define kCC18_1AUMComponentVersionStr	"18.1.0."
#endif

// ----- Version string for Adobe Crash Reporter
#if CC18_1_DOT_RELEASE_NUMBER
#define kCC18_1CRAdobeProductVersionStr "18101"
#else
#define kCC18_1CRAdobeProductVersionStr "18100"
#endif

#define kCC18_1CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2023"
#define kCC18_1CRAdobeInCopyDisplayNameStr    "(Adobe InCopy 2023)"
...
#define kCC18_1MajorScriptVersionNumber	RezLong(18)
#define kCC18_1MinorScriptVersionNumber	RezLong(1)
