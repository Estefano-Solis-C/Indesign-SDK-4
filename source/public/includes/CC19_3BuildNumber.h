...
#ifndef __CC19_3BuildNumber_h__
#define __CC19_3BuildNumber_h__
...
//
#define kCC19_3VersionNumber 19.3
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC19_3VersionNumberStr "19.3"
...
//
#ifdef BETA_BUILD
#define kCC19_3UIVersionStr "2024 (Beta)"
#elif PRERELEASE_BUILD
#define kCC19_3UIVersionStr "2024 (Prerelease)"
#else
#define kCC19_3UIVersionStr "2024"
#endif
...
// ----- This DOES NOT change when we have a dot release
//
#define kCC19_3CCVersionYearBasedHandleStr "2024"

// ----- This represents year based full version handle of the product to
//		 be presented to the user in about screen.
// ----- This DOES NOT change when we have a dot release
//
#define kCC19_3CCVersionYearBasedFullHandleStr "2024.3"


// ----- CC19_3_DOT_RELEASE_NUMBER represents the product dot
//		release version.
...
//		1. Change CC19_3_DOT_RELEASE_NUMBER to non-zero
// 			(If you want 4.0.2 change it to 2.)
//		2. Update kCC19_3VersionNumberForResourceStr
//		3. Update kCC19_3VersionCopyRightStr for the Mac
//		4. Update kCC19_3CFBundleVersionStr for the Mac (4.0.1 would be "4010")
//		5. Update kCC19_3AUMComponentVersionStr
//		6. Update kCC19_3CRAdobeProductVersionStr similar to kCC19_3CFBundleVersionStr
// 
...
//
#define CC19_3_DOT_RELEASE_NUMBER 0

#if CC19_3_DOT_RELEASE_NUMBER
#define kCC19_3VersionNumberForResourceStr "19.3.1"
#else
#define kCC19_3VersionNumberForResourceStr "19.3"
#endif

// ----- Used for plug-in actual and expected version numbers
#define kCC19_3MajorVersionNumber RezLong(19)
#define kCC19_3MinorVersionNumber RezLong(3)
#define kCC19_3DotVersionNumber  RezLong(CC19_3_DOT_RELEASE_NUMBER)

// ----- Numbers for 'vers', FILEVERSION and PRODUCTVERSION resources.
#define kCC19_3MajorVersionNumberForResource 19
#define kCC19_3MinorVersionNumberForResource 3
#define kCC19_3DotVersionNumberForResource CC19_3_DOT_RELEASE_NUMBER
...
#ifdef MACINTOSH
#if CC19_3_DOT_RELEASE_NUMBER
#define kCC19_3VersionCopyRightStr "19.3.1, Copyright 1999-2024 Adobe Inc. All rights reserved."
#define kCC19_3CFBundleVersionStr "19310"
#else
#define kCC19_3VersionCopyRightStr "19.3, Copyright 1999-2024 Adobe Inc. All rights reserved."
#define kCC19_3CFBundleVersionStr "19300"
#endif
#endif

#ifdef WINDOWS
#define kCC19_3VersionCopyRightStr "Copyright 1999-2024 Adobe. All rights reserved."
#define kCC19_3ShortCopyRightStr "© 1999-2024 Adobe. All rights reserved."
#endif

// ----- Version string for Adobe Update Manager managed components
#if CC19_3_DOT_RELEASE_NUMBER
#define kCC19_3AUMComponentVersionStr	"19.3.1."
#else
#define kCC19_3AUMComponentVersionStr	"19.3.0."
#endif
// ----- Version string for Adobe Crash Reporter
#if CC19_3_DOT_RELEASE_NUMBER
#define kCC19_3CRAdobeProductVersionStr	"19.3.1"
#else
#define kCC19_3CRAdobeProductVersionStr	"19.3.0"
#endif

// ----- Display name for Adobe Crash Reporter
#define kCC19_3CRAdobeInDesignDisplayNameStr	"Adobe InDesign 2024"
#define kCC19_3CRAdobeInCopyDisplayNameStr	"(Adobe InCopy 2024)"
...
#define kCC19_3MajorScriptVersionNumber	RezLong(19)
#define kCC19_3MinorScriptVersionNumber	RezLong(3)
