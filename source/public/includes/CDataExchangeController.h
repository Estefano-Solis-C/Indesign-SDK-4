...
class PUBLIC_DECL CDataExchangeController : public IDataExchangeController
{
	...
	protected:
		...
		*/
        ...
        //this should be called only from clipboard interfaces for Mac and windows
        virtual bool16  IsClipboardExternal() const{
            ASSERT_FAIL("CDataExchangeController::IsClipboardExternal: should not be called here");
            return kFalse;}
