...
protected:
	...
	*/
	...
	/** Get unique file name for export operation
		@param document IN the document you want to export
		@param sysFileName IN is the reference of file being exported
		@param uniqueSysFileName IN is the reference of unique export file name which will be created after adding the suffix value
		@param pageNum IN. the page number of page in the exporting document
		@param outputPages IN List of output pages being exported
		@param exportSpreads IN whether export spreads
		@param suffix IN is the suffix string
		@param exportFileExtension IN is the extention of the export file
	*/
