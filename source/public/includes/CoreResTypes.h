...
#define kSVGArtRsrcType						'SVGA' // resource type SVGA, SVG ART!
#define kSVGArtRollOverRsrcType				'SVGR' // resource type SVGR, SVG ART!
#define kSVGArtDarkRsrcType					'SVGD' // resource type SVGAD, SVG ART!
#define kSVGArtRollOverDarkRsrcType			'SVGK' // resource type SVGRD, SVG ART!
...
#define kSVGCursorRsrcType					'SVGC'
