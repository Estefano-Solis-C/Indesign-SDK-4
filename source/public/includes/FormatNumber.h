...
#define kCC17MajorFormatNumber              RezLong(23) // Major format number for any new persistent data in 17.0
#define kCC18MajorFormatNumber              RezLong(24) // Major format number for any new persistent data in 18.0
#define kCC19MajorFormatNumber              RezLong(25) // Major format number for any new persistent data in 19.0

#define kCurrentMajorFormatNumber			kCC19MajorFormatNumber
...
#define kCC17InitialMinorFormatNumber       RezLong(1)
#define kCC18InitialMinorFormatNumber       RezLong(1)
#define kCC19InitialMinorFormatNumber       RezLong(1)
