...
public:
	...
	*/
	...
	/** Load an icon into this object for later drawing.
		...
		@param iconRsrcID the icon/PNG/SVG resource id within the plugin
		...
		@param isAdornmentIcon whether the icon is an adornment. If true, InDesign will scale the SVG icon based on the UI Scaling preference.
	*/
	...
	*/
	...
	/** API from old PlatformIcon class 
	 	@param inRsrcID the icon/PNG/SVG resource id within the plugin
		@param brightnessAware if true, the icon switches according to UI brightness at
		                       drawing time. Else bright UI icon is always drawn.
		@param isAdornmentIcon whether the icon is an adornment. If true, InDesign will scale the SVG icon based on the UI Scaling preference.				   
	*/
	...
	/** Draw the icon previously loaded into this object
		@param graphicsPort the graphics port to draw into
	*/
