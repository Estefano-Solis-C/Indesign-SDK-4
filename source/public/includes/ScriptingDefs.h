...
enum ScriptEvents
{
  ...
  e_Recover =     'rcvr', // Special recovery method used internally
    ...
    e_InternalMethod        =    'inte', // Internal method to be used in InDesign context only.
    p_InternalMethodParam1  =    'inp1', // Internal method parameter 1 to be used with internal method in InDesign context only.
    p_InternalMethodParam2  =    'inp2', // Internal method parameter 2 to be used with internal method in InDesign context only.
    e_SaveAsCloud               = 'eSCD',
	e_SaveACopyCloud            = 'eSAC',
    e_OpenCloudDocumentMethod   = 'eOCD',
    e_DeleteCloudDocumentMethod = 'eDCD',
    e_HomeScreenVisibilityChange = 'HSVc',
    p_cloudAssetRefMethodParam  = 'pCAR',
};
...
//	en_Vertical					=	'ptVr',	// already en_Vertical
	...
	p_fileAssetRefMethodParam = 'pFAR',
	e_ImportPref = 'eIMP',
	e_ExportPref = 'eEXP',
	e_ResetPref = 'eRSP',
	p_SetActiveWorkspace = 'pSAW',
	p_KeyboardShortcutSet = 'pKSS',
...
p_PanelTabHeightPref = 'pThP',
	...
	p_ModifyIndentsAroundTextWrap = 'mitw',
	...
	p_PDFExExportHiddenSpread	= 'DFEh',   /* bool */		// Whether to export hidden spreads in the PDF
...
//	p_OTFStylisticAlt =		'OTsa',		use p_OTFStylistAlt
	...
	p_EPubAccessibilityFeature			=	'eacf',
	p_EPubAccessibilityHazard			=	'ehaz',
	p_EPubAccessibilityMode				=	'emod',
	p_EPubAccessibilityModeSufficient	=	'emos',
	p_EPubAccessibilitySummary			=	'easu',
	p_EPubAccessibilityConformsTo		=	'eact',
	p_EPubAccessibilityCertifiedBy		=	'ecer',
	p_EPubAccessibilityCredentials		=	'ecrd',
	p_EPubAccessibilityReportLink		=	'earl',
	p_CreatePageNavigation				=	'ecpn',
    ...
    //variable font method
    e_IsNthDesignAxisHidden   =  'gndv',
};
