...
namespace StringUtils
{
	...
	*/
	...
	/** Converts Strings to their Normalized form as per the Unicode Standard

		@param instring string to convert
		@return the converted Normalized string
		*/
	PUBLIC_DECL PMString NormalizeUnicodeString(const PMString &instring);
