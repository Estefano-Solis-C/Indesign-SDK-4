...
public:
	...
	*/
    ...
    /** IsNthDesignAxisHidden
     @param data Pointer to IScriptRequestData expected to contain index of design axis of variable font.
     @param script Pointer to script boss, see comments at top of file.
     @param fontClass Boss must implement IID_ITEXTATTRUID
     @param styleClass Boss must implement IID_ITEXTATTRFONT
     @return kSuccess if successful or returns an error code.
     */
