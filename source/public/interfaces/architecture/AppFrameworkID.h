...
DECLARE_PMID(kInterfaceIDSpace, IID_IINTERNAL_SCRIPT_METHOD_MANAGER,    kAppFrameworkPrefix + 92)
DECLARE_PMID(kInterfaceIDSpace, IID_IINTERNAL_SCRIPT_METHOD_HANDLER,    kAppFrameworkPrefix + 93)
DECLARE_PMID(kInterfaceIDSpace, IID_ISTDSTRINGTOSTRINGMAPDATA,    kAppFrameworkPrefix + 94)
DECLARE_PMID(kInterfaceIDSpace, IID_IINTERRUPTABLEASYNCEXECUTOR,				kAppFrameworkPrefix + 95)
DECLARE_PMID(kInterfaceIDSpace, IID_IRESETPREFERENCESDATA,				kAppFrameworkPrefix + 96)
...
DECLARE_PMID(kImplementationIDSpace, kInternalScriptMethodManagerImpl, kAppFrameworkPrefix + 138)
DECLARE_PMID(kImplementationIDSpace, kInternalScriptMethodHandlerServiceImpl, kAppFrameworkPrefix + 139)
DECLARE_PMID(kImplementationIDSpace, kStdStringToStringMapDataImpl, kAppFrameworkPrefix + 140)
DECLARE_PMID(kImplementationIDSpace, kInterruptableAsyncExecutorImpl, kAppFrameworkPrefix + 141)
DECLARE_PMID(kImplementationIDSpace, kImportExportPrefsImpl, kAppFrameworkPrefix + 142)
DECLARE_PMID(kImplementationIDSpace, kResetPreferencesDataImpl, kAppFrameworkPrefix + 143)
...
DECLARE_PMID(kServiceIDSpace, kInternalScriptMethodHandlerService,  kAppFrameworkPrefix + 11)
...
DECLARE_PMID(kErrorIDSpace, kInternalScriptMethodNotFoundError,       kAppFrameworkPrefix + 10)
DECLARE_PMID(kErrorIDSpace, kInternalScriptMethodOperatesOnDocumentContextError,       kAppFrameworkPrefix + 11)
...
DECLARE_PMID(kScriptInfoIDSpace, kAppFocusChangedEventScriptElement,			kAppFrameworkPrefix + 58)
...
DECLARE_PMID(kScriptInfoIDSpace, kInternalMethodScriptElement,                  kAppFrameworkPrefix + 107)
DECLARE_PMID(kScriptInfoIDSpace, kDeleteCloudDocMethodScriptElement,			kAppFrameworkPrefix + 108)
DECLARE_PMID(kScriptInfoIDSpace, kOpenCloudDocMethodScriptElement,              kAppFrameworkPrefix + 109)
...
DECLARE_PMID(kScriptInfoIDSpace, kImportSettingsScriptElement,					kAppFrameworkPrefix + 189)
DECLARE_PMID(kScriptInfoIDSpace, kExportSettingsScriptElement,					kAppFrameworkPrefix + 190)
DECLARE_PMID(kScriptInfoIDSpace, kResetPreferencesScriptElement,				kAppFrameworkPrefix + 191)
