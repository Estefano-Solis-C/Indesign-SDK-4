...
DECLARE_PMID(kClassIDSpace, kUIScalingPrefsBoss, kAppUIPrefix + 204)
DECLARE_PMID(kClassIDSpace, kUIScalingPrefsDialogBoss, kAppUIPrefix + 205)
DECLARE_PMID(kClassIDSpace, kSetUIScalingPrefsCmdBoss, kAppUIPrefix + 206)
DECLARE_PMID(kClassIDSpace, kSetUIScalingPrefsRestartCmdBoss, kAppUIPrefix + 207)
// gap
...
//gap
DECLARE_PMID(kClassIDSpace, kBadArchAlertDialogBoss, kAppUIPrefix + 240)
DECLARE_PMID(kClassIDSpace, kBadArchAlertStartupShutdownBoss, kAppUIPrefix + 241)
DECLARE_PMID(kClassIDSpace, kBadArchAlertSavePrefCmdBoss, kAppUIPrefix + 242)
DECLARE_PMID(kClassIDSpace, kSenseiWorkflowDialogBoss, kAppUIPrefix + 243)
DECLARE_PMID(kClassIDSpace, kUXPPanelBoss, kAppUIPrefix + 244)
DECLARE_PMID(kClassIDSpace, kUXPExtensionBoss, kAppUIPrefix + 245)

DECLARE_PMID(kClassIDSpace, kOnCanvasOptionsDialogBoss, kAppUIPrefix + 246)
DECLARE_PMID(kClassIDSpace, kOnCanvasOptionsExpandedTrayPopupWindowBoss, kAppUIPrefix + 247)
DECLARE_PMID(kClassIDSpace, kFeatureFlagChangeSignalMgrBoss, kAppUIPrefix + 248)

DECLARE_PMID(kClassIDSpace, kAutoStyleFeedbackDialogBoss, kAppUIPrefix + 249)

DECLARE_PMID(kClassIDSpace, kContextBarHUDPanelBoss, kAppUIPrefix + 250)
DECLARE_PMID(kClassIDSpace, kContextBarHUDPanelWindowBoss, kAppUIPrefix + 251)
DECLARE_PMID(kClassIDSpace, kContextBarHUDPanelGripperViewBoss, kAppUIPrefix + 252)
DECLARE_PMID(kClassIDSpace, kContextBarHUDIconPopUpBoss, kAppUIPrefix + 253)
DECLARE_PMID(kClassIDSpace, kContextBarHUDMenuPopUpBoss, kAppUIPrefix + 254)
DECLARE_PMID(kClassIDSpace, kSetContextBarHUDIsVisiblePrefsCmdBoss, kAppUIPrefix + 255)

DECLARE_PMID(kClassIDSpace, kSetContextBarHUDIsPinnedPrefsCmdBoss, kAppUIPrefix2 + 1)
DECLARE_PMID(kClassIDSpace, kSetContextBarHUDPositionPrefsCmdBoss, kAppUIPrefix2 + 2)
DECLARE_PMID(kClassIDSpace, kGenAIProgressBarDialogBoss, kAppUIPrefix2 + 3)
DECLARE_PMID(kClassIDSpace, kCBNavigationPanelWidgetBoss, kAppUIPrefix2 + 4)
DECLARE_PMID(kClassIDSpace, kImportExportPrefsActionComponentBoss, kAppUIPrefix2 + 5)
DECLARE_PMID(kClassIDSpace, kContextBarHUDTextBoxWidgetBoss, kAppUIPrefix2 + 6)
DECLARE_PMID(kClassIDSpace, kContextBarHUDGenerateWidgetBoss, kAppUIPrefix2 + 7)
DECLARE_PMID(kClassIDSpace, kContextBarHUDGenerateOptnWidgetBoss, kAppUIPrefix2 + 8)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IBADARCHSHOWDIALOGBOOLDATA, kAppUIPrefix+134)
DECLARE_PMID(kInterfaceIDSpace, IID_IBADARCHSHOWDIALOGPLUGINCOUNTDATA, kAppUIPrefix+135)
DECLARE_PMID(kInterfaceIDSpace, IID_IPMSTRINGLIST, kAppUIPrefix+136)


DECLARE_PMID(kInterfaceIDSpace, IID_IUISCALINGPREFS, kAppUIPrefix + 137 )
DECLARE_PMID(kInterfaceIDSpace, IID_IBINARYHARDENING, kAppUIPrefix + 138 )
DECLARE_PMID(kInterfaceIDSpace, IID_ISENSEIWORKFLOWTYPE, kAppUIPrefix+139)
DECLARE_PMID(kInterfaceIDSpace, IID_ISENSEIWORKFLOWUPDATETRIGGER, kAppUIPrefix+140)
DECLARE_PMID(kInterfaceIDSpace, IID_ISENSEIWORKFLOWUIDATA, kAppUIPrefix+141)
DECLARE_PMID(kInterfaceIDSpace, IID_ISENSEIWORKFLOWSUCCEEDED, kAppUIPrefix+142)

// OnCanvasOptions
DECLARE_PMID(kInterfaceIDSpace, IID_IONCANVASOPTIONSWIDGETHELPER, kAppUIPrefix + 143)
DECLARE_PMID(kInterfaceIDSpace, IID_IONCANVASOPTIONSWIDGETCLICKED, kAppUIPrefix + 144)
DECLARE_PMID(kInterfaceIDSpace, IID_IONCANVASOPTIONSAUTOUNDOFLAG, kAppUIPrefix + 145)
DECLARE_PMID(kInterfaceIDSpace, IID_IHIDEBLUEDOTFORINTELLISTYLE_NUDGE, kAppUIPrefix + 146)
DECLARE_PMID(kInterfaceIDSpace, IID_IHIDEONCANVASOPTIONSTRAY, kAppUIPrefix + 147)
DECLARE_PMID(kInterfaceIDSpace, IID_IOWLHOSTEDDOCUMENTICONUTILS, kAppUIPrefix + 148 )
DECLARE_PMID(kInterfaceIDSpace, IID_ICUSTOMURLUTILS, kAppUIPrefix + 149)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPPANEL, kAppUIPrefix+150)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPPANELMANAGER, kAppUIPrefix+151)
DECLARE_PMID(kInterfaceIDSpace, IID_ISENSEIWORKFLOWERRORCODE, kAppUIPrefix+152)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPPANELMGROBSERVER, kAppUIPrefix+153)
DECLARE_PMID(kInterfaceIDSpace, IID_ISMARTSTYLESPANEL_SELECTIONOBSERVER, kAppUIPrefix+154)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPPANELLOADIDLETASK, kAppUIPrefix+155)
DECLARE_PMID(kInterfaceIDSpace, IID_ICACHEDFEATUREFLAGS, kAppUIPrefix+156)
DECLARE_PMID(kInterfaceIDSpace, IID_ICONTEXTBARHUDPANELMGR, kAppUIPrefix+157)


// UXP GenAI utils
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPGENAIUTILS, kAppUIPrefix+158)

//Layout Selection for Context Bar
DECLARE_PMID(kInterfaceIDSpace, IID_ICONTEXTBARLAYOUTSELECTIONOBSERVER, kAppUIPrefix+159)

DECLARE_PMID(kInterfaceIDSpace, IID_ICONTEXTBARHUDPREFS, kAppUIPrefix+160)

DECLARE_PMID(kInterfaceIDSpace, IID_IIMPORTEXPORTPREFERENCES, kAppUIPrefix+161)

DECLARE_PMID(kInterfaceIDSpace, IID_IGENAIPANEL_SELECTIONOBSERVER, kAppUIPrefix+162)
DECLARE_PMID(kInterfaceIDSpace, IID_ICONTEXTBARACTIVECONTEXT, kAppUIPrefix+163)
...
DECLARE_PMID(kWidgetIDSpace, kUIScalingPrefsDialogWidgetID, kAppUIPrefix2 + 14)
DECLARE_PMID(kWidgetIDSpace, kUIScalingPrefsPanelWidgetID, kAppUIPrefix2 + 15)
DECLARE_PMID(kWidgetIDSpace, kUIScalingTextPreviewWidgetID, kAppUIPrefix2 + 16)
DECLARE_PMID(kWidgetIDSpace, kUIScalingPrefsTitleTextWidgetID, kAppUIPrefix2 + 17)
DECLARE_PMID(kWidgetIDSpace, kUIScalingScaleFactorSliderWidgetID, kAppUIPrefix2 + 18)
DECLARE_PMID(kWidgetIDSpace, kUIScalingScaleCursorCheckboxWidgetID, kAppUIPrefix2 + 19)
DECLARE_PMID(kWidgetIDSpace, kUIScalingBoundingBoxSliderWidgetID, kAppUIPrefix2 + 20)
DECLARE_PMID(kWidgetIDSpace, kUIScalingWarningTextWidgetID, kAppUIPrefix2 + 21)

//gap
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertDialogWidgetID, kAppUIPrefix2 + 22)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertIconSuiteWidgetID, kAppUIPrefix2 + 23)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertStaticTextLine1WidgetID, kAppUIPrefix2 + 24)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertMultilineTextWidgetID, kAppUIPrefix2 + 25)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertBadTextWidgetID, kAppUIPrefix2 + 26)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertScrollWidgetID, kAppUIPrefix2 + 27)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertDontShowCheckboxWidgetID, kAppUIPrefix2 + 28)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertStaticTextLine2WidgetID, kAppUIPrefix2 + 29)
DECLARE_PMID(kWidgetIDSpace, kBadArchAlertTitleTextWidgetID, kAppUIPrefix2 + 30)
DECLARE_PMID(kWidgetIDSpace, kBadArchHyperlinkWidgetID, kAppUIPrefix2 + 31)
DECLARE_PMID(kWidgetIDSpace, kUIScalingPreviewIconWidgetID, kAppUIPrefix2 + 32)
DECLARE_PMID(kWidgetIDSpace, kCursorWidgetID, kAppUIPrefix2 + 33)
DECLARE_PMID(kWidgetIDSpace, kInformationIconAndTextWidgetID, kAppUIPrefix2 + 34)
DECLARE_PMID(kWidgetIDSpace, kPreviewTextWidgetID, kAppUIPrefix2 + 35)
DECLARE_PMID(kWidgetIDSpace, kSliderWidgetID, kAppUIPrefix2 + 36)
DECLARE_PMID(kWidgetIDSpace, kSmallLargeWidgetID, kAppUIPrefix2 + 37)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogWidgetID, kAppUIPrefix2 + 38)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogProgressBarWidgetID, kAppUIPrefix2 + 39)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogProgressMessageWidgetID, kAppUIPrefix2 + 40)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogProgressParentWidgetID, kAppUIPrefix2 + 41)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogMessageTextWidgetID, kAppUIPrefix2 + 42)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogMessageParentWidgetID, kAppUIPrefix2 + 43)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogNormalWorkflowGroupWidgetID, kAppUIPrefix2 + 44)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogErrorMessageTextWidgetID, kAppUIPrefix2 + 45)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogWarningIconId, kAppUIPrefix2 + 46)
DECLARE_PMID(kWidgetIDSpace, kSenseiWorkflowDialogErrorGroupWidgetID, kAppUIPrefix2 + 47)
DECLARE_PMID(kWidgetIDSpace, kOnCanvasOptionsIconWidgetID, kAppUIPrefix2 + 48)
DECLARE_PMID(kWidgetIDSpace, kOnCanvasOptionsNudgeWidgetID, kAppUIPrefix2 + 49)
DECLARE_PMID(kWidgetIDSpace, kOnCanvasOptionsDialogWidgetId, kAppUIPrefix2 + 50)
DECLARE_PMID(kWidgetIDSpace, kOnCanvasOptionsPanelId, kAppUIPrefix2 + 51)
DECLARE_PMID(kWidgetIDSpace, kOnCanvasOptionsExpandedTrayPanelId, kAppUIPrefix2 + 52)
DECLARE_PMID(kWidgetIDSpace, kFormatPasteWidgetId, kAppUIPrefix2 + 53)
DECLARE_PMID(kWidgetIDSpace, kTextPasteWidgetId, kAppUIPrefix2 + 54)
DECLARE_PMID(kWidgetIDSpace, kIntelliStyleWidgetId, kAppUIPrefix2 + 55)
DECLARE_PMID(kWidgetIDSpace, kCloseWidgetId, kAppUIPrefix2 + 56)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackDialogWidgetID, kAppUIPrefix2 + 58)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackThankYouWidgetID, kAppUIPrefix2 + 59)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackMessageWidgetID, kAppUIPrefix2 + 60)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackOption1WidgetID, kAppUIPrefix2 + 61)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackOption2WidgetID, kAppUIPrefix2 + 62)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackOtherWidgetID, kAppUIPrefix2 + 63)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackMultilineTextEditBoxWidgetID, kAppUIPrefix2 + 64)
DECLARE_PMID(kWidgetIDSpace, kAutoStyleFeedbackDontShowAgainWidgetID, kAppUIPrefix2 + 65)
DECLARE_PMID(kWidgetIDSpace, kFirstUXPPanelWidgetID, kAppUIPrefix2 + 66)
...
DECLARE_PMID(kWidgetIDSpace, kLastUXPPanelWidgetID, kAppUIPrefix2 + 216)


// Onto the third prefix here...
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDWidgetId, kAppUIPrefix3 + 1)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDGripperContainerWidgetID, kAppUIPrefix3 + 2)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDGripperWidgetID, kAppUIPrefix3 + 3)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDTextBoxWidgetID, kAppUIPrefix3 + 4)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDGenerateWidgetID, kAppUIPrefix3 + 5)
DECLARE_PMID(kWidgetIDSpace, kItemsListDDWidgetID, kAppUIPrefix3 + 6)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDQueryWidgetID, kAppUIPrefix3 + 7)
DECLARE_PMID(kWidgetIDSpace, kText2ImgPanelWidgetID, kAppUIPrefix3 + 8)
DECLARE_PMID(kWidgetIDSpace, kLeftNavigationIconWidgetID, kAppUIPrefix3 + 9)
DECLARE_PMID(kWidgetIDSpace, kImageIndexDetailWidgetID, kAppUIPrefix3 + 10)
DECLARE_PMID(kWidgetIDSpace, kRightNavigationIconWidgetID, kAppUIPrefix3 + 11)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDMoreOptnsIconDropDownWidgetID, kAppUIPrefix3 + 12)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDGraphicFrameWidgetID, kAppUIPrefix3 + 13)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDTextToImageWidgetID, kAppUIPrefix3 + 14)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDBackWidgetID, kAppUIPrefix3 + 15)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDFlyOutWidgetID, kAppUIPrefix3 + 16)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDImportImageWidgetID, kAppUIPrefix3 + 17)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDBackGroupButtonWidgetID, kAppUIPrefix3 + 18)
DECLARE_PMID(kWidgetIDSpace, kContextBarNavigationWidgetID, kAppUIPrefix3 + 19)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDRelinkImageWidgetID, kAppUIPrefix3 + 20)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDDoneWidgetID, kAppUIPrefix3 + 21)
DECLARE_PMID(kWidgetIDSpace, kGenAIProgressBarDialogWidgetID, kAppUIPrefix3 + 22)
DECLARE_PMID(kWidgetIDSpace, kGenAIProgressBarTipTextWidgetID, kAppUIPrefix3 + 23)
DECLARE_PMID(kWidgetIDSpace, kGenAIProgressBarWidgetID, kAppUIPrefix3 + 24)
DECLARE_PMID(kWidgetIDSpace, kContextBarAutoCropWidgetID, kAppUIPrefix3 + 25)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDGenExpandWidgetID, kAppUIPrefix3 + 26)
DECLARE_PMID(kWidgetIDSpace, kGenAIDropDownWidgetID, kAppUIPrefix3 + 27)
DECLARE_PMID(kWidgetIDSpace, kContextBarHUDDropDownWidgetID, kAppUIPrefix3 + 28)
...
// gap
DECLARE_PMID(kImplementationIDSpace, kBadArchAlertDialogControllerImpl, kAppUIPrefix2 + 138)
DECLARE_PMID(kImplementationIDSpace, kBadArchAlertDialogObserverImpl, kAppUIPrefix2 + 139)
DECLARE_PMID(kImplementationIDSpace, kBadArchCheckIdleTaskImpl, kAppUIPrefix2 + 140)
DECLARE_PMID(kImplementationIDSpace, kBadArchAlertStartupShutdownImpl, kAppUIPrefix2 + 141)
DECLARE_PMID(kImplementationIDSpace, kBadArchAlertShowDialogImpl, kAppUIPrefix2 + 142)
DECLARE_PMID(kImplementationIDSpace, kBadArchAlertPluginCountImpl, kAppUIPrefix2 + 143)
DECLARE_PMID(kImplementationIDSpace, kSaveBadArchAlertPrefCmdImpl, kAppUIPrefix2 + 144)
DECLARE_PMID(kImplementationIDSpace, kBadArchAlertCmdDataImpl, kAppUIPrefix2 + 145)
DECLARE_PMID(kImplementationIDSpace, kPersistIntList_V2Impl, kAppUIPrefix2 + 146)
DECLARE_PMID(kImplementationIDSpace, kPersistStringListImpl, kAppUIPrefix2 + 147)
DECLARE_PMID(kImplementationIDSpace, kStringListImpl, kAppUIPrefix2 + 148)

DECLARE_PMID(kImplementationIDSpace, kUIScalingPrefsComponentImpl, kAppUIPrefix2 + 149)
DECLARE_PMID(kImplementationIDSpace, kUIScalingPrefsPanelCreatorImpl, kAppUIPrefix2 + 150)
DECLARE_PMID(kImplementationIDSpace, kUIScalingPrefsDialogObserverImpl, kAppUIPrefix2 + 151)
DECLARE_PMID(kImplementationIDSpace, kUIScalingPrefsImpl, kAppUIPrefix2 + 152)
DECLARE_PMID(kImplementationIDSpace, kUIScalingPrefsDialogControllerImpl, kAppUIPrefix2 + 153)
DECLARE_PMID(kImplementationIDSpace, kSetUIScalingPrefsCmdImpl, kAppUIPrefix2 + 154)
DECLARE_PMID(kImplementationIDSpace, kSetUIScalingPrefsRestartCmdImpl, kAppUIPrefix2 + 155)
DECLARE_PMID(kImplementationIDSpace, kCBinaryHardeningImpl, kAppUIPrefix2 + 156)
DECLARE_PMID(kImplementationIDSpace, kSenseiWorkflowDialogControllerImpl, kAppUIPrefix2 + 157)
DECLARE_PMID(kImplementationIDSpace, kSenseiWorkflowDialogObserverImpl, kAppUIPrefix2 + 158)
DECLARE_PMID(kImplementationIDSpace, kSenseiWorkflowUIDataImpl, kAppUIPrefix2 + 159)

DECLARE_PMID(kImplementationIDSpace, kOnCanvasOptionsNudgeTipImpl, kAppUIPrefix2 + 160)
DECLARE_PMID(kImplementationIDSpace, kOnCanvasOptionsWidgetHelperImpl, kAppUIPrefix2 + 161)
DECLARE_PMID(kImplementationIDSpace, kOnCanvasOptionsDialogObserverImpl, kAppUIPrefix2 + 162)
DECLARE_PMID(kImplementationIDSpace, kOnCanvasOptionsExpandedTrayPositioningHelperImpl, kAppUIPrefix2 + 163)
DECLARE_PMID(kImplementationIDSpace, kOnCanvasOptionsExpandedTrayPopupWindowImpl, kAppUIPrefix2 + 164)
DECLARE_PMID(kImplementationIDSpace, kOnCanvasOptionsExpandedTrayWindowEHImpl, kAppUIPrefix2 + 165)
DECLARE_PMID(kImplementationIDSpace, kHideBlueDotForIntellistyleNudgeImpl, kAppUIPrefix2 + 166)
DECLARE_PMID(kImplementationIDSpace, kOwlHostedDocumentIconUtilsImpl, kAppUIPrefix2 + 167)
DECLARE_PMID(kImplementationIDSpace, kCustomURLUtilsImpl, kAppUIPrefix2 + 168)
DECLARE_PMID(kImplementationIDSpace, kUXPPanelImpl, kAppUIPrefix2 + 169)
DECLARE_PMID(kImplementationIDSpace, kUXPPanelViewImpl, kAppUIPrefix2 + 170)
DECLARE_PMID(kImplementationIDSpace, kUXPPanelManagerImpl, kAppUIPrefix2 + 171)
DECLARE_PMID(kImplementationIDSpace, kUXPPanelMgrObserverImpl, kAppUIPrefix2 + 172)
DECLARE_PMID(kImplementationIDSpace, kSmartStylesPanelSelectionObserverImpl, kAppUIPrefix2 + 173)
DECLARE_PMID(kImplementationIDSpace, kUXPLoadPanelIdleTaskImpl, kAppUIPrefix2 + 174)
DECLARE_PMID(kImplementationIDSpace, kCachedFeatureFlagsImpl, kAppUIPrefix2 + 175)
DECLARE_PMID(kImplementationIDSpace, kAutoStyleFeedbackDialogControllerImpl, kAppUIPrefix2 + 176)
DECLARE_PMID(kImplementationIDSpace, kAutoStyleFeedbackDialogObserverImpl, kAppUIPrefix2 + 177)
DECLARE_PMID(kImplementationIDSpace, kAutoStyleFeedbackDontShowClickedBoolDataImpl, kAppUIPrefix2 + 178)

DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPanelMgrImpl, kAppUIPrefix2 + 179)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPanelWindowImpl, kAppUIPrefix2 + 180)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPanelObserverImpl, kAppUIPrefix2 + 181)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPanelGripperViewImpl, kAppUIPrefix2 + 182)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPanelViewImpl, kAppUIPrefix2 + 183)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDWindowEHImpl, kAppUIPrefix2 + 184)
DECLARE_PMID(kImplementationIDSpace, kUXPGenAIUtilsImpl, kAppUIPrefix2 + 185) // From Service
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDMenuComponentImpl, kAppUIPrefix2 + 186)
DECLARE_PMID(kImplementationIDSpace, kContextBarLayoutSelectionObserverImpl, kAppUIPrefix2 + 187)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPrefsImpl, kAppUIPrefix2 + 188)
DECLARE_PMID(kImplementationIDSpace, kSetContextBarHUDIsVisiblePrefsCmdImpl, kAppUIPrefix2 + 189)
DECLARE_PMID(kImplementationIDSpace, kSetContextBarHUDIsPinnedPrefsCmdImpl, kAppUIPrefix2 + 190)
DECLARE_PMID(kImplementationIDSpace, kSetContextBarHUDPositionPrefsCmdImpl, kAppUIPrefix2 + 191)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPositioningHelperImpl, kAppUIPrefix2 + 192)
DECLARE_PMID(kImplementationIDSpace, kGenAIProgressBarDialogControllerImpl, kAppUIPrefix2 + 193)
DECLARE_PMID(kImplementationIDSpace, kCBNavigationSelectionObserverImpl, kAppUIPrefix2 + 194)

DECLARE_PMID(kImplementationIDSpace, kImportExportPrefsActionComponentImpl, kAppUIPrefix2 + 195)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDTextBoxTipImpl, kAppUIPrefix2 + 196)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDPromptEditBoxEHImpl, kAppUIPrefix2 + 197)
DECLARE_PMID(kImplementationIDSpace, kContextBarPopupEventHandlerImpl, kAppUIPrefix2 + 198)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDGenerateBtnTipImpl, kAppUIPrefix2 + 199)
DECLARE_PMID(kImplementationIDSpace, kGenAIPanelSelectionObserverImpl, kAppUIPrefix2 + 200)
DECLARE_PMID(kImplementationIDSpace, kContextBarActiveContextImpl, kAppUIPrefix2 + 201)
DECLARE_PMID(kImplementationIDSpace, kContextBarHUDGenerateOptnDropDownTipImpl, kAppUIPrefix2 + 202)
...
DECLARE_PMID(kServiceIDSpace, kFeatureFlagsInitializedFromService, kAppUIPrefix + 9)
DECLARE_PMID(kServiceIDSpace, kFeatureFlagsInitializationFailedFromService, kAppUIPrefix + 10)
...
DECLARE_PMID(kActionIDSpace, kUIScalingPrefsActionID, kAppUIPrefix2 + 106)


DECLARE_PMID(kActionIDSpace, kFirstUXPPanelActionID, kAppUIPrefix2 + 107) //107
DECLARE_PMID(kActionIDSpace, kLastUXPPanelActionID, kAppUIPrefix2 + 255)

// Onto the third prefix here...
DECLARE_PMID(kActionIDSpace, kContextBarHUDShowPanelActionID, kAppUIPrefix3 + 0)
DECLARE_PMID(kActionIDSpace, kContextBarHUDGuidelinesActionID, kAppUIPrefix3 + 1)
DECLARE_PMID(kActionIDSpace, kHideContextBarHUDActionID, kAppUIPrefix3 + 2)
DECLARE_PMID(kActionIDSpace, kPinContextBarHUDActionID, kAppUIPrefix3 + 3)
DECLARE_PMID(kActionIDSpace, kContextBarHUDGenerateActionID, kAppUIPrefix3 + 4)
DECLARE_PMID(kActionIDSpace, kToggleContextBarHUDActionID, kAppUIPrefix3 + 5)
DECLARE_PMID(kActionIDSpace, kContextBarHUDGoodResultActionID, kAppUIPrefix3 + 6)
DECLARE_PMID(kActionIDSpace, kContextBarHUDBadResultActionID, kAppUIPrefix3 + 7)
DECLARE_PMID(kActionIDSpace, kContextBarHUDReportVariationActionID, kAppUIPrefix3 + 8)
DECLARE_PMID(kActionIDSpace, kImportPrefsActionID, kAppUIPrefix3 + 9)
DECLARE_PMID(kActionIDSpace, kExportPrefsActionID, kAppUIPrefix3 + 10)
DECLARE_PMID(kActionIDSpace, kShowText2ImagePanelActionID, kAppUIPrefix3 + 11)
DECLARE_PMID(kActionIDSpace, kContextBarHUDSep1ActionID, kAppUIPrefix3 + 12)
DECLARE_PMID(kActionIDSpace, kContextBarHUDSep2ActionID, kAppUIPrefix3 + 13)
DECLARE_PMID(kActionIDSpace, kShowText2ImagePanelContextMenuActionID, kAppUIPrefix3 + 14)
DECLARE_PMID(kActionIDSpace, kPropertiesPanelText2ImageQuickActionID, kAppUIPrefix3 + 15)
...
DECLARE_PMID(kScriptInfoIDSpace, kShowPasteOptionsPropertyScriptElement,   				kAppUIPrefix + 252)
DECLARE_PMID(kScriptInfoIDSpace, kSetActiveWorkspaceScriptElement,   					kAppUIPrefix + 253)
DECLARE_PMID(kScriptInfoIDSpace, kKeyboardShortcutSetScriptElement,   					kAppUIPrefix + 254)
...
#define kIntelliStyleBlueDotIconResID						7016
...
#define kAutoStyleFeedbackDialogRsrcID                      7020
