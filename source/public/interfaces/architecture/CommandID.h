...
DECLARE_PMID(kMessageIDSpace, kUndoHistoryItemMessage, kCommandPrefix + 35)
DECLARE_PMID(kMessageIDSpace, kRedoHistoryItemMessage, kCommandPrefix + 36)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ITIMEDATA, kCommandPrefix + 60)
DECLARE_PMID(kInterfaceIDSpace, IID_ISTDSTRINGDATA, kCommandPrefix + 61)
...
DECLARE_PMID(kImplementationIDSpace, kTimeDataImpl, kCommandPrefix + 68)
DECLARE_PMID(kImplementationIDSpace, kStdStringDataImpl, kCommandPrefix + 69)
