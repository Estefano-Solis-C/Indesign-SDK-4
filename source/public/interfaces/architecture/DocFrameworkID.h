...
DECLARE_PMID(kInterfaceIDSpace, IID_ICLOUDDOCURI,                       kDocFrameworkPrefix + 46)
...
DECLARE_PMID(kErrorIDSpace, kCloudDocumentPropertyNotExistError,		kDocFrameworkPrefix + 77)
DECLARE_PMID(kErrorIDSpace, kLocalDocumentPropertyNotExistError,		kDocFrameworkPrefix + 78)
DECLARE_PMID(kErrorIDSpace, kUnsavedDocumentPropertyNotExistError,		kDocFrameworkPrefix + 79)
// <Ignore>
...
DECLARE_PMID(kScriptInfoIDSpace, kSaveAsCloudDocumentMethodScriptElement,    kDocFrameworkPrefix + 88)
...
DECLARE_PMID(kScriptInfoIDSpace, kIsCloudDocumentPropertyScriptElement,			kDocFrameworkPrefix + 214)
DECLARE_PMID(kScriptInfoIDSpace, kCloudPathPropertyScriptElement,				kDocFrameworkPrefix + 215)
...
DECLARE_PMID(kScriptInfoIDSpace, kSaveACopyCloudDocumentMethodScriptElement,    kDocFrameworkPrefix + 237)
