...
DECLARE_PMID(kImplementationIDSpace, kRecentCloudFileListImpl, kDocumentPrefix + 120)
// <Service ID>
// Service IDs
...
DECLARE_PMID(kErrorIDSpace, kConversionFailedDueToActiveClones, kDocumentPrefix + 23)
