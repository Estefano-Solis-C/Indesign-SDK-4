...
public:
	...
	*/
	...
	typedef enum
	{
        ...
        kAccessDenied //destionation file access denied because of permission issues.
	} DBResultCode;
	...
	*/
    ...
    /**
        FOR INTERNAL USE ONLY
        FOR EXTERNAL USE : Recommended to use IAdobeMediaMgmtMetaData::GetDocumentID
     
        Sets the document ID of a document.
        [IN]: nil
        [OUT]: Returns the documentID of the document associated with the database.
    */
	...
	*/
    ...
    typedef enum {
        ...
        /*File opened by stripping the XMP data from file*/
        kUsingXMPDataStripping,
        /*File opened by fixing/stripping the invalid text story or parcel from file*/
