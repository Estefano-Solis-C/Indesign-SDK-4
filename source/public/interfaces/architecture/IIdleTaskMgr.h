    ...
    enum IdleTaskEvents {SleepEvent, WakeEvent, MouseClickEvent, KeyEvent, AppOutOfFocus, AppInFocus};
		...
		*/
        ...
        /**
            ...
            Returns Sleep Flag used for disabling idletasks while going to sleep.
         */
        virtual bool16 GetSleepFlag() = 0;
        
        /**
		    FOR INTERNAL USE ONLY [Deprecated]
            Sets Sleep Flag used for disabling idletasks while going to sleep.
            @param sleepFlag, Bypass call to RunOverdueTasks() if set to kTrue, else execute RunOverdueTasks() normally.
         */
        ...
        /**
            FOR INTERNAL USE ONLY
            Sets Sleep Flag used for disabling idletasks while going to sleep.
            @param idleTaskEvent, Bypass call to RunOverdueTasks() on wake,keydown and mouseclick event.
        */
