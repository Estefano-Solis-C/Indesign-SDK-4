...
DECLARE_PMID(kServiceIDSpace, kEPubExportFXLMetadataSelectableDialogService,kImportExportUIPrefix + 8)
DECLARE_PMID(kServiceIDSpace, kEPubExportMetadataSelectableDialogService,kImportExportUIPrefix + 9)
...
//gap
DECLARE_PMID(kClassIDSpace, kEPubExportFXLMetadataGeneralPanelBoss,			kImportExportUIPrefix + 80)
DECLARE_PMID(kClassIDSpace, kEPubExportFXLMetadataAccessibilityPanelBoss,			kImportExportUIPrefix + 81)
DECLARE_PMID(kClassIDSpace, kEPubExportFXLMetadataTabsWidgetBoss, kImportExportUIPrefix + 82)
DECLARE_PMID(kClassIDSpace, kEPubExportMetadataGeneralPanelBoss,			kImportExportUIPrefix + 83)
DECLARE_PMID(kClassIDSpace, kEPubExportMetadataAccessibilityPanelBoss,			kImportExportUIPrefix + 84)
DECLARE_PMID(kClassIDSpace, kEPubExportMetadataTabsWidgetBoss, kImportExportUIPrefix + 85)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ISUPPRESS_SHAREDCONTENT_M2M_VALIDATE_ON_OPEN, kImportExportUIPrefix + 36)
...
// gap
// Epub Export related
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLMetadataGeneralPanelCreatorImpl,	kImportExportUIPrefix + 170)
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLMetadataAccessibilityPanelCreatorImpl,	kImportExportUIPrefix + 171)
DECLARE_PMID(kImplementationIDSpace, kEPubExportMetadataGeneralPanelCreatorImpl,	kImportExportUIPrefix + 172)
DECLARE_PMID(kImplementationIDSpace, kEPubExportMetadataAccessibilityPanelCreatorImpl,	kImportExportUIPrefix + 173)
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLMetadataGeneralPanelObserverImpl,	kImportExportUIPrefix + 174) 
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLMetadataAccessibilityPanelObserverImpl,	kImportExportUIPrefix + 175) 
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLMetadataTabsDialogCreatorImpl,				kImportExportUIPrefix + 176)
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLMetadataTabPanelObserverImpl,				kImportExportUIPrefix + 177)
DECLARE_PMID(kImplementationIDSpace, kEPubExportMetadataTabPanelObserverImpl,				kImportExportUIPrefix + 178)
DECLARE_PMID(kImplementationIDSpace, kEPubExportMetadataTabsDialogCreatorImpl,				kImportExportUIPrefix + 179)
DECLARE_PMID(kImplementationIDSpace, kEPubExportMetadataGeneralPanelObserverImpl,	kImportExportUIPrefix + 180) 
DECLARE_PMID(kImplementationIDSpace, kEPubExportMetadataAccessibilityPanelObserverImpl,	kImportExportUIPrefix + 181) 
...
DECLARE_PMID(kWidgetIDSpace, kCoverAlternativeTextWidgetID,			        kImportExportUIPrefix + 226)
DECLARE_PMID(kWidgetIDSpace, kCoverAlternativeTextEditBoxWidgetID,		    kImportExportUIPrefix + 227)
DECLARE_PMID(kWidgetIDSpace, kPageNavigationCheckboxWidgetID,				kImportExportUIPrefix + 228)
...
//gap
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilitySummaryTextEditBoxWidgetID,  kImportExportUIPrefix2 + 20)
DECLARE_PMID(kWidgetIDSpace, kEPubExportFXLMetadataGeneralPanelGroupWidgetID,				kImportExportUIPrefix2 + 21)
DECLARE_PMID(kWidgetIDSpace, kEPubExportFXLMetadataAccessibilityPanelGroupWidgetID,				kImportExportUIPrefix2 + 22)
DECLARE_PMID(kWidgetIDSpace, kEPubExportMetadataGeneralPanelGroupWidgetID,				kImportExportUIPrefix2 + 23)
DECLARE_PMID(kWidgetIDSpace, kEPubExportMetadataAccessibilityPanelGroupWidgetID,				kImportExportUIPrefix2 + 24)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityMetadataGroupPanelWidgetID, kImportExportUIPrefix2 + 25)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityMetadataGroupLabelWidgetID, kImportExportUIPrefix2 + 26)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityMetadataGroupPanelHeaderWidgetID, kImportExportUIPrefix2 + 27)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityMetadataGroupPanelRightHeaderWidgetID, kImportExportUIPrefix2 + 28)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityFeatureDropDownWidgetID,			kImportExportUIPrefix2 + 29)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityCredentialsGroupPanelWidgetID, kImportExportUIPrefix2 + 30)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityCredentialsGroupLabelWidgetID, kImportExportUIPrefix2 + 31)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityCredentialsGroupPanelHeaderWidgetID, kImportExportUIPrefix2 + 32)
DECLARE_PMID(kWidgetIDSpace, kAccessibilityCredentialsGroupPanelRightHeaderWidgetID, kImportExportUIPrefix2 + 33)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityHazardDropDownWidgetID,			kImportExportUIPrefix2 + 34)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityAccessModeDropDownWidgetID,			kImportExportUIPrefix2 + 35)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityAccessModeSufficientDropDownWidgetID,			kImportExportUIPrefix2 + 36)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilitySummaryTextEditWidgetID,			kImportExportUIPrefix2 + 37)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityCredentialsConformsToDownWidgetID,			kImportExportUIPrefix2 + 38)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityCredentialsCertifiedByEditTextWidgetID,			kImportExportUIPrefix2 + 39)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityCertifierCredentialsEditTextWidgetID,			kImportExportUIPrefix2 + 40)
DECLARE_PMID(kWidgetIDSpace, kMetadataAccessibilityCertifierReportLinkToEditBoxWidgetID,			kImportExportUIPrefix2 + 41)
DECLARE_PMID(kWidgetIDSpace, kEPubExportFXLMetadataTabButtonWidgetID,		kImportExportUIPrefix2 + 42)
DECLARE_PMID(kWidgetIDSpace, kEPubExportMetadataTabButtonWidgetID,          kImportExportUIPrefix2 + 43)
...
DECLARE_PMID(kActionIDSpace, kLaunchI2EID, kImportExportUIPrefix + 23)
