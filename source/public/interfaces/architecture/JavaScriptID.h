...
DECLARE_PMID(kClassIDSpace, kUxpScriptEngineBoss,						    kJavaScriptPrefix + 8)
DECLARE_PMID(kClassIDSpace, kUxpScriptRequestDataBoss,                      kJavaScriptPrefix + 9)
DECLARE_PMID(kClassIDSpace, kUxpScriptMgrBoss,						        kJavaScriptPrefix + 10)
DECLARE_PMID(kClassIDSpace, kUxpScriptFunctorBoss,						    kJavaScriptPrefix + 11)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPSCRIPTENGINE,                       kJavaScriptPrefix + 8)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPSCRIPTDATACONVERTER,                kJavaScriptPrefix + 9)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPSCRIPTUTILS,                        kJavaScriptPrefix + 10)
DECLARE_PMID(kInterfaceIDSpace, IID_IUXPSCRIPTCLIENTFUNCTOR,				kJavaScriptPrefix + 11)
...
DECLARE_PMID(kImplementationIDSpace, kUxpScriptJsEngineImpl,			    kJavaScriptPrefix + 16)
DECLARE_PMID(kImplementationIDSpace, kUxpScriptEngineImpl,			    kJavaScriptPrefix + 17)

DECLARE_PMID(kImplementationIDSpace, kUxpScriptSpecificImpl,                     kJavaScriptPrefix + 18) 
DECLARE_PMID(kImplementationIDSpace, kUxpScriptRequestDataImpl,                  kJavaScriptPrefix + 19) 
DECLARE_PMID(kImplementationIDSpace, kUxpScriptDataConverterImpl,                kJavaScriptPrefix + 20)

DECLARE_PMID(kImplementationIDSpace, kUxpScriptMgrImpl,			    kJavaScriptPrefix + 21)
DECLARE_PMID(kImplementationIDSpace, kUxpScriptUtilsImpl,			    kJavaScriptPrefix + 22)
DECLARE_PMID(kImplementationIDSpace, kUxpScriptRunnerImpl,			    kJavaScriptPrefix + 23)
DECLARE_PMID(kImplementationIDSpace, kUxpScriptCoreFunctorImpl,			kJavaScriptPrefix + 24)
DECLARE_PMID(kImplementationIDSpace, kUxpScriptClientFunctorImpl,			kJavaScriptPrefix + 25)
