...
DECLARE_PMID(kErrorIDSpace, kExtensionChangedError, kOpenPlacePrefix+11)
DECLARE_PMID(kErrorIDSpace, kPDFToInDesignDocThroughDragDropError, kOpenPlacePrefix+12)
// Action IDs
