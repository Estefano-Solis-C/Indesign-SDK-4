...
DECLARE_PMID(kClassIDSpace, kShowMissingPluginRecoveryDialogCmdBoss, kSavebackServicePrefix + 8)
...
DECLARE_PMID(kClassIDSpace, kMissingPluginRecoveryDialogBoss, kSavebackServicePrefix + 27)
...
DECLARE_PMID(kImplementationIDSpace, kShowMissingPluginRecoveryDialogCmdImpl, kSavebackServicePrefix + 16)
...
DECLARE_PMID(kImplementationIDSpace, kMissingPluginRecoveryDialogControllerImpl, kSavebackServicePrefix + 28)
DECLARE_PMID(kImplementationIDSpace, kMissingPluginRecoveryDialogObserverImpl, kSavebackServicePrefix + 29)
