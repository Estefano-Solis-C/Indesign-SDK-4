...
DECLARE_PMID(kClassIDSpace, kPluginsMenuBoss, kShuksanPrefix + 206 )
...
DECLARE_PMID(kWidgetIDSpace, kOpenIDMLDocButtonWidgetID, kShuksanPrefix + 95)
...
DECLARE_PMID(kImplementationIDSpace, kPluginsMenuImpl, kShuksan2Prefix + 238)
...
DECLARE_PMID(kImplementationIDSpace, kMissingPluginsObserverImpl, kShuksan2Prefix + 250 )
...
DECLARE_PMID(kActionIDSpace, kBrowsePluginsActionID, kShuksan2Prefix + 51)
DECLARE_PMID(kActionIDSpace, kManagePluginsActionID, kShuksan2Prefix + 52)
...
DECLARE_PMID(kFileTypeInfoIDSpace, kHEIFFileTypeInfoID, kShuksanPrefix + 70)
DECLARE_PMID(kFileTypeInfoIDSpace, kWEBPFileTypeInfoID, kShuksanPrefix + 71)
DECLARE_PMID(kFileTypeInfoIDSpace, kJP2KFileTypeInfoID, kShuksanPrefix + 72)
DECLARE_PMID(kFileTypeInfoIDSpace, kInDesignCloudDocFileTypeInfoID, kShuksanPrefix + 73)
...
DECLARE_PMID(kProductIDSpace, kNoneProduct, kShuksanPrefix + 4)
