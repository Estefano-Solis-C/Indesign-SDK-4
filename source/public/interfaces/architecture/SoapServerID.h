...
DECLARE_PMID(kClassIDSpace, kLogIDSAnalyticsIdleTaskHandlerBoss,			kSoapServerIDPrefix + 13)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IIDSLOGGINGUTILS, 						kSoapServerIDPrefix + 6)
...
DECLARE_PMID(kImplementationIDSpace, kLogIDSAnalyticsIdleTaskImpl,			kSoapServerIDPrefix + 20)
DECLARE_PMID(kImplementationIDSpace, kIDSLoggingUtilsImpl,					kSoapServerIDPrefix + 21)
