...
DECLARE_PMID(kClassIDSpace, kPDFToInDesignDocOpenProviderBoss, kPDFExtraPrefix + 71)
DECLARE_PMID(kClassIDSpace, kPDFToInDesignDocParseAndAddItemsCmdBoss, kPDFExtraPrefix + 72)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IINTERACTIVEPDFEXPORTPREFS_4, kPDFPrefix + 200)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IINCREMENTALNOSINGLEPAGEPDF, kPDFExtraPrefix + 43 )
//gap
DECLARE_PMID(kInterfaceIDSpace, IID_IPDFTOINDESIGNDOC_MANAGER, kPDFExtraPrefix + 60 )
DECLARE_PMID(kInterfaceIDSpace, IID_IPDFTOINDESIGNDOCPARSEANDADDITEMSCMDDATA, kPDFExtraPrefix + 61 )
DECLARE_PMID(kInterfaceIDSpace, IID_IPDFTOINDESIGNDOCIDLETASK, kPDFExtraPrefix + 62 )
// <Implementation ID>
//----------------------------------------------------------------------------------------
//
// Implementation ids
...
DECLARE_PMID(kImplementationIDSpace, kInteractivePDFExportPrefs_4Impl, kPDFExtraPrefix + 224)
DECLARE_PMID(kImplementationIDSpace, kIncrementalNoSinglePagePDFImpl, kPDFExtraPrefix + 225)
//gap
DECLARE_PMID(kImplementationIDSpace, kPDFToInDesignDocImportProviderImpl, kPDFExtraPrefix + 235)
DECLARE_PMID(kImplementationIDSpace, kPDFToInDesignDocManagerImpl, kPDFExtraPrefix + 236)
DECLARE_PMID(kImplementationIDSpace, kPDFToInDesignDocParseAndAddItemsCmdImpl, kPDFExtraPrefix + 237)
DECLARE_PMID(kImplementationIDSpace, kPDFToInDesignDocParseAndAddItemsCmdDataImpl, kPDFExtraPrefix + 238)
DECLARE_PMID(kImplementationIDSpace, kPDFToInDesignDocIdleTaskImpl, kPDFExtraPrefix + 239)
...
DECLARE_PMID(kWidgetIDSpace, kNoExportPDFWarningWidgetId, kPDFExtraPrefix + 210)

DECLARE_PMID(kWidgetIDSpace, kPDFExportHiddenSpreadNotePanelWidgetId, kPDFExtraPrefix + 211)
DECLARE_PMID(kWidgetIDSpace, kPDFExportHiddenSpreadNoteWidgetId, kPDFExtraPrefix + 212)
DECLARE_PMID(kWidgetIDSpace, kPDFExp_OptExportHiddenSpreadWidgetId, kPDFExtraPrefix + 213)

DECLARE_PMID(kWidgetIDSpace, kIPDF_HiddenSpreadNotePanelWID, kPDFExtraPrefix + 214)
DECLARE_PMID(kWidgetIDSpace, kIPDF_HiddenSpreadNoteWID, kPDFExtraPrefix + 215)
DECLARE_PMID(kWidgetIDSpace, kIPDF_ExportHiddenSpreadCheckboxWID, kPDFExtraPrefix + 216)
...
DECLARE_PMID(kErrorIDSpace, kPDFErrorFromAGMPDFPort, kPDFPrefix + 29)
DECLARE_PMID(kErrorIDSpace, kPDFErrorFromPDFL, kPDFPrefix + 30)
DECLARE_PMID(kErrorIDSpace, kPDFErrorFromInDesign, kPDFPrefix + 31)
DECLARE_PMID(kErrorIDSpace, kPDFErrorPageNum, kPDFPrefix + 32)
...
DECLARE_PMID(kScriptInfoIDSpace, kPDFExportHiddenSpreadPropertyScriptElement, kPDFExtraPrefix + 35)
