...
DECLARE_PMID(kClassIDSpace, kPNGExportOutputPagesBoss, kPNGFilterPrefix + 10)
...
DECLARE_PMID(kScriptInfoIDSpace, kPNGExportSuffixPropertyScriptElement, kPNGFilterPrefix + 31)
DECLARE_PMID(kScriptInfoIDSpace, kPNGExportHiddenSpreadPropertyScriptElement, kPNGFilterPrefix + 32)
...
// ViewPortAttrIDs
DECLARE_PMID(kViewPortAttrIDSpace, kPNGExportVPAttr, kPNGFilterPrefix + 1)
