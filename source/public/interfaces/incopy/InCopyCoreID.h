...
DECLARE_PMID(kClassIDSpace, kOversetInfoInternalScriptMethodHandlerBoss,  kInCopyCorePrefix + 72)
...
DECLARE_PMID(kImplementationIDSpace, kOversetInfoInternalScriptMethodHandlerImpl, kInCopyCorePrefix + 92)
DECLARE_PMID(kImplementationIDSpace, kInCopySessionPageSetupPrefsImpl, kInCopyCorePrefix + 93)
DECLARE_PMID(kImplementationIDSpace, kInCopyDocStyleLockInfoImpl, kInCopyCorePrefix + 94)
DECLARE_PMID(kImplementationIDSpace, kInCopyDocStyleScriptImpl, kInCopyCorePrefix + 95)
...
DECLARE_PMID(kErrorIDSpace, kJSONParsingError,   kInCopyCorePrefix + 2)
DECLARE_PMID(kErrorIDSpace, kParameterIncorrectTypeError, kInCopyCorePrefix + 3)
DECLARE_PMID(kErrorIDSpace, kStoryIDNotFoundError,   kInCopyCorePrefix + 4)
DECLARE_PMID(kErrorIDSpace, kCopyfittingCannotInstantiateError,   kInCopyCorePrefix + 5)
DECLARE_PMID(kErrorIDSpace, kCopyfittingGenericError,   kInCopyCorePrefix + 6)
DECLARE_PMID(kErrorIDSpace, kUnableToCreateStreamOnInputFilePathError,   kInCopyCorePrefix + 7)
