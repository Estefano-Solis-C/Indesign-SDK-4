//========================================================================================
//  
//  $File: //depot/shuksan/source/public/interfaces/layout/GenericID.h $
//  
//  Owner: Robin_Briggs
//  
//  $Author: mbiswas $
...
DECLARE_PMID(kActionIDSpace, kCaptureTypeActionID, kGenericIDPrefix + 137)
DECLARE_PMID(kActionIDSpace, kCaptureColorActionID, kGenericIDPrefix + 138)
DECLARE_PMID(kActionIDSpace, kCaptureShapeActionID, kGenericIDPrefix + 139)
...
enum GenericScriptIDs
{
	...
	en_SourceXMPAltText			= 'sTXa',
	en_SourceXMPExtendedDescription		= 'sTXe',
