...
DECLARE_PMID(kInterfaceIDSpace, IID_IPRESENTATIONMODEFLOORCOLOR, kLayoutUIPrefix + 113)
...
DECLARE_PMID(kImplementationIDSpace, kPresentationModeFloorColorImpl, kLayoutUI2Prefix + 154)
