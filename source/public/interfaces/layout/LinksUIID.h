...
DECLARE_PMID(kInterfaceIDSpace, IID_IKFILESCLOSING, kLinksUIPrefix + 21)        // IID_IBOOLDATA
...
DECLARE_PMID(kActionIDSpace, kLinksUIRelinkToCCACAssetActionID, kLinksUIPrefix + 64)
