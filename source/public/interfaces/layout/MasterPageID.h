...
DECLARE_PMID(kClassIDSpace, kSetAssetRefForMasterPageCmd, kMasterPagesPrefix + 59)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IASSETREFDATAFORMASTERPAGE, kMasterPagesPrefix + 44)
...
DECLARE_PMID(kImplementationIDSpace, kAssetRefDataForMasterPageImpl, kMasterPagesPrefix + 101)

//Setting assetRef Impl

DECLARE_PMID(kImplementationIDSpace, kSetAssetRefForMasterPageCmdImpl, kMasterPagesPrefix + 102)
