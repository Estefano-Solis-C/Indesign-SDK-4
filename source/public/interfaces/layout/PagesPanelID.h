...
DECLARE_PMID(kActionIDSpace, kDuplicatePageAfterSelectionActionID, kPagesPanelPrefix + 75)
DECLARE_PMID(kActionIDSpace, kHidePageActionID, kPagesPanelPrefix + 76)
