...
#define kChangeFormatChangeCaseRsrcID					9300
#define kChangeFormatChangeCaseSelRsrcID				9400
...
DECLARE_PMID(kClassIDSpace, kChangeFormatChangeCasePanelBoss, kFindChangeFormatPanelPrefix + 44)
DECLARE_PMID(kClassIDSpace, kChangeCaseObserverBoss, kFindChangeFormatPanelPrefix + 45)
...
DECLARE_PMID(kImplementationIDSpace, kChangeFormatChangeCaseRsrcDataImpl, kFindChangeFormatPanelPrefix + 61)
DECLARE_PMID(kImplementationIDSpace, kChangeCaseObserverImpl, kFindChangeFormatPanelPrefix + 62)
...
DECLARE_PMID(kWidgetIDSpace, kChangeFormatCaseWidgetID, kFindChangeFormatPanelPrefix + 57)
DECLARE_PMID(kWidgetIDSpace, kChangeFormatCaseOptionWidgetID, kFindChangeFormatPanelPrefix + 58)
