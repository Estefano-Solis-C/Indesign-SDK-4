...
DECLARE_PMID(kClassIDSpace, kFontsInternalScriptMethodHandlerBoss, kFontMgrPrefix + 194)
...
DECLARE_PMID(kInterfaceIDSpace, IID_IMISSING_FONTS_DIALOG_SCHEDULED, kFontMgrPrefix + 32)
...
DECLARE_PMID(kImplementationIDSpace, kFontsInternalScriptMethodHandlerImpl, kFontMgrPrefix + 242)
DECLARE_PMID(kImplementationIDSpace, kMissingFontsDialogScheduledImpl, kFontMgrPrefix + 243)
...
DECLARE_PMID(kErrorIDSpace, kDesignAxisHiddenError,                 kFontMgrPrefix +26)
DECLARE_PMID(kErrorIDSpace, kFontDocCannotInstantiateError,         kFontMgrPrefix +27)
