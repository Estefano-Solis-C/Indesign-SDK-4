...
DECLARE_PMID(kClassIDSpace, kIconWidgetWithClickBoss, kFontUsagePrefix + 35)
...
DECLARE_PMID(kImplementationIDSpace, kIconSuiteWidgetWithClickEHImpl, kFontUsagePrefix + 45)
DECLARE_PMID(kImplementationIDSpace, kType1FontIAMPrefImpl, kFontUsagePrefix + 46)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ITYPE1FONTIAMPREF, kFontUsagePrefix + 18)
...
DECLARE_PMID(kWidgetIDSpace, kFontUsageType1CountLabelWidgetID, kFontUsagePrefix + 143)
// <Action ID>
// ActionIDs
