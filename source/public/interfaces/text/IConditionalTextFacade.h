	...
	public:
		...
		*/
		...
		/**	Loads the condition from a cloud asset represented by sourceFile
			@param ws IN Workspace to get the name of the condition set uid from.
			@param sourceFile IN cloud asset of the document.
			@param loadConditionTagSets IN If kTrue then loads the condition sets; otherwise, only loads the conditions.
			@return ErrorCode kSuccess if no errors were encountered getting the conditions otherwise an error code.
		*/
