...
public:
	...
	@see IFindChangeOptions::SearchMode
	@return is of type PMString
	@see IFindChangeFormatData::SetChangeCaseOption
	*/
	virtual const PMString& GetChangeCaseOption(IFindChangeOptions::SearchMode mode = IFindChangeOptions::kTextSearch) =0;

	/**
	Sets the ChangeCase Option that will be applied on found text/object
	@param tagName is of type PMString specifying ChangeCase Option
	@param mode is of type IFindChangeOptions::SearchMode specifying the mode of Find/Change
	@see IFindChangeOptions::SearchMode
	@see IFindChangeFormatData::GetChangeCaseOption
	*/
