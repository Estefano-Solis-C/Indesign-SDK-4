...
// NewStylePack onboarding with a blue dot icon 
#define kStylePanelMenusWithIconRsrcID      1300
#define kNewStylePackOnBoardingIconID      1301
...
DECLARE_PMID(kClassIDSpace, kSmartStylePackPanelButtonBoss, kStylePanelPrefix + 106)
DECLARE_PMID(kClassIDSpace, kApplySmartStylePackButtonBoss, kStylePanelPrefix + 107)
DECLARE_PMID(kClassIDSpace, kNewStylePackDialogBoss, kStylePanelPrefix + 108)
DECLARE_PMID(kClassIDSpace, kNewStylePackMappingListWidgetBoss, kStylePanelPrefix + 110)
DECLARE_PMID(kClassIDSpace, kNewStylePackListElementWidgetBoss, kStylePanelPrefix + 111)
DECLARE_PMID(kClassIDSpace, kNewStylePackInDesignStyleInLineContainerWidgetBoss, kStylePanelPrefix + 112)
DECLARE_PMID(kClassIDSpace, kNewStylePackStyleTreeBasedDropDownListWidgetBoss, kStylePanelPrefix + 113)
DECLARE_PMID(kClassIDSpace, kNewStylePackStyleTreeBasedPopupWindowBoss, kStylePanelPrefix + 114)
DECLARE_PMID(kClassIDSpace, kNewStylePackStyleTreeBasedPopupEditBoxBoss, kStylePanelPrefix + 115)
DECLARE_PMID(kClassIDSpace, kNewStylePackStylePopupTreeViewWidgetBoss, kStylePanelPrefix + 116)
DECLARE_PMID(kClassIDSpace, kTreeBasedStyleDropDownListWidgetBoss, kStylePanelPrefix + 117)
DECLARE_PMID(kClassIDSpace, kStyleTreeBasedPopupWindowBoss, kStylePanelPrefix + 118)
DECLARE_PMID(kClassIDSpace, kThumbnailImageViewBoss, kStylePanelPrefix + 119)
// <Widget ID>
// Widget IDs
...
DECLARE_PMID(kWidgetIDSpace, kSmartStylePackPanelButtonWidgetID, kStylePanelPrefix + 198)
DECLARE_PMID(kWidgetIDSpace, kSmartStylePackPanelButtonSeparatorWidgetID, kStylePanelPrefix + 199)
DECLARE_PMID(kWidgetIDSpace, kApplySmartStylePackButtonWidgetID, kStylePanelPrefix + 200)
DECLARE_PMID(kWidgetIDSpace, kApplySmartStylePackButtonIconId, kStylePanelPrefix + 201)
DECLARE_PMID(kWidgetIDSpace, kApplySmartStylePackButtonSmallIconId, kStylePanelPrefix + 202)
DECLARE_PMID(kWidgetIDSpace, kSmartStyleFolderIconId, kStylePanelPrefix + 203)
DECLARE_PMID(kWidgetIDSpace, kSmartStyleFolderSmallIconId, kStylePanelPrefix + 204)
DECLARE_PMID(kWidgetIDSpace, kSmartStyleFolderWideIconId, kStylePanelPrefix + 205)
DECLARE_PMID(kWidgetIDSpace, kSmartStyleFolderWideBlueDotIconId, kStylePanelPrefix + 206)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackDialogRsrcID, kStylePanelPrefix + 207)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackDialogWidgetID, kStylePanelPrefix + 208)
DECLARE_PMID(kWidgetIDSpace, kStylePackNameLabelWidgetId, kStylePanelPrefix + 209)
DECLARE_PMID(kWidgetIDSpace, kStylePackNamePrefixWidgetId, kStylePanelPrefix + 210)
DECLARE_PMID(kWidgetIDSpace, kStylePackNameEdixBoxWidgetId, kStylePanelPrefix + 211)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackGroupLabelWidgetId, kStylePanelPrefix + 212)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingsSplitterWidgetID, kStylePanelPrefix + 213)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingsHeaderSplitterWidgetID, kStylePanelPrefix + 214)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingsTagNameWidgetID, kStylePanelPrefix + 215)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingsInDesignStyleNameWidgetID, kStylePanelPrefix + 216)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingsTagNameContainerWidgetID, kStylePanelPrefix + 217)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingsInDesignStyleNameContainerWidgetID, kStylePanelPrefix + 218)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingListElementRsrcID, kStylePanelPrefix + 219)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackLeftSplitterPanelWidgetID, kStylePanelPrefix + 220)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackRightSplitterPanelWidgetID, kStylePanelPrefix + 221)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackListElementContainerWidgetID, kStylePanelPrefix + 222)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackMappingListElementWidgetID, kStylePanelPrefix + 223)
DECLARE_PMID(kWidgetIDSpace, kTagStyleIconWidgetID, kStylePanelPrefix + 224)
DECLARE_PMID(kWidgetIDSpace, kInDesignStyleIconWidgetID, kStylePanelPrefix + 225)
DECLARE_PMID(kWidgetIDSpace, kStylePackPreviewPNGRsrcID, kStylePanelPrefix + 226)
DECLARE_PMID(kWidgetIDSpace, kStyleGroupOptionsColumn31WidgetID, kStylePanelPrefix + 227)
DECLARE_PMID(kWidgetIDSpace, kNewStylePackStyleDDListWidgetID, kStylePanelPrefix + 228)
// <Implementation ID>
// ImplementationIDs
...
DECLARE_PMID(kImplementationIDSpace, kSmartStylePackPanelButtonObserverImpl, kStylePanelPrefix + 147)
DECLARE_PMID(kImplementationIDSpace, kApplySmartStylePackButtonObserverImpl, kStylePanelPrefix + 148)
DECLARE_PMID(kImplementationIDSpace, kHideBlueDotForIntelliStyleImpl, kStylePanelPrefix + 149)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackDialogControllerImpl, kStylePanelPrefix + 150)
DECLARE_PMID(kImplementationIDSpace, kMappedStylesListDataImpl, kStylePanelPrefix + 151)
DECLARE_PMID(kImplementationIDSpace, kStylePackStyleNamesListImpl, kStylePanelPrefix + 152)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackMappingListTreeViewAdapterImpl, kStylePanelPrefix + 154)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackMappingListWidgetMgrImpl, kStylePanelPrefix + 155)
DECLARE_PMID(kImplementationIDSpace, kStylePanelForCloudUtilsImpl, kStylePanelPrefix + 156)
DECLARE_PMID(kImplementationIDSpace, kShowIntellistyleOnboardingImpl, kStylePanelPrefix + 157)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackStyleDropDownRelatedDataImpl, kStylePanelPrefix + 158)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackStyleTreeBasedPopupFlyoutViewImpl, kStylePanelPrefix + 159)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackStyleTreeViewObserverImpl, kStylePanelPrefix + 160)
DECLARE_PMID(kImplementationIDSpace, kAttributeNameImpl, kStylePanelPrefix + 161)
DECLARE_PMID(kImplementationIDSpace, kThumbnailImageViewImpl, kStylePanelPrefix + 162)
DECLARE_PMID(kImplementationIDSpace, kShowAutoStyleOnboardingImpl, kStylePanelPrefix + 163)
DECLARE_PMID(kImplementationIDSpace, kShowCustomStylePacksOnboardingImpl, kStylePanelPrefix + 164)
DECLARE_PMID(kImplementationIDSpace, kStylePackPanelTriggerClickedImpl, kStylePanelPrefix + 165)
DECLARE_PMID(kImplementationIDSpace, kNewStylePackDialogDataImpl, kStylePanelPrefix + 166)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ISTYLEPANELFORCLOUDUTILS, kStylePanelPrefix + 24)
DECLARE_PMID(kInterfaceIDSpace, IID_IATTRIBUTENAME, kStylePanelPrefix + 25)
DECLARE_PMID(kInterfaceIDSpace, IID_IDIALOGDATA, kStylePanelPrefix + 26)
...
DECLARE_PMID(kActionIDSpace, kParaStylePopupSep10ActionID, kStylePanelPrefix + 87)
...
DECLARE_PMID(kActionIDSpace, kContextMenuApplySmartStylePackActionID, kStylePanelPrefix + 102)
DECLARE_PMID(kActionIDSpace, kNewSmartStylePackActionID, kStylePanelPrefix + 103)
DECLARE_PMID(kActionIDSpace, kAutoStyleActionID, kStylePanelPrefix + 104)
DECLARE_PMID(kActionIDSpace, kParaStylePopupSep5ActionID_SpecialForAutoStyle, kStylePanelPrefix + 105)
DECLARE_PMID(kActionIDSpace, kContextMenuNewStylePackActionID, kStylePanelPrefix + 106)
DECLARE_PMID(kActionIDSpace, kContextMenuEditStylePackActionID, kStylePanelPrefix + 107)
DECLARE_PMID(kActionIDSpace, kContextMenuSaveAsCustomStylePackActionID, kStylePanelPrefix + 108)
