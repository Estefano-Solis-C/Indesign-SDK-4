...
// AutoStyle onboarding with a blue dot icon
#define kAutoStyleOnBoardingIconID          1302
#define kTextEditorMenusWithIconRsrcID      1303
...
DECLARE_PMID(kClassIDSpace, kSetShowAutoStyleNudgePrefsCmdBoss, kTextEditorPrefix + 102)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ISHOW_AUTO_STYLE_NUDGE, kTextEditorPrefix + 36)
DECLARE_PMID(kInterfaceIDSpace, IID_ITEXTPASTEOPTIONSUTILS, kTextEditorPrefix + 37)
