...
DECLARE_PMID(kWidgetIDSpace, kModifyIndentsAroundTextWrapWidgetID, kTextOptionsPanelPrefix + 62)
//gap
...
DECLARE_PMID(kWidgetIDSpace, kShaperChangeID, kTextOptionsPanelPrefix2 + 55)
