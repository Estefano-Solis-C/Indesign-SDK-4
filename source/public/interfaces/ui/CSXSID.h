//========================================================================================
//  
//  $File: //depot/shuksan/source/public/interfaces/ui/CSXSID.h $
//  
...
DECLARE_PMID(kClassIDSpace, kCSXSScriptObserverBoss,                    kCSXSPrefix + 47)
...
DECLARE_PMID(kImplementationIDSpace, kCaptureWorkflowUtilsImpl,        kCSXSPrefix + 97)
DECLARE_PMID(kImplementationIDSpace, kSmartStylesPanelExtensionImpl, kCSXSPrefix + 98)
DECLARE_PMID(kImplementationIDSpace, kTargetUIDListForRelinkingContextImpl,        kCSXSPrefix + 99)
DECLARE_PMID(kImplementationIDSpace, kCSXSScriptObserverImpl, 		    kCSXSPrefix + 100)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ICAPTUREWORKFLOWUTILS, kCSXSPrefix + 70)
DECLARE_PMID(kInterfaceIDSpace, IID_ISMARTSTYLES_PANEL_EXTENSION, kCSXSPrefix + 71)
DECLARE_PMID(kInterfaceIDSpace, IID_ITARGETUIDLISTFORRELINKINGCONTEXT, kCSXSPrefix + 72)
...
DECLARE_PMID(kMessageIDSpace, kHomeScreenVisibilityChange,				kCSXSPrefix + 3)
...
DECLARE_PMID(kScriptInfoIDSpace, kHomeScreenVisibilityChangeScriptElement,              kCSXSPrefix + 21)
