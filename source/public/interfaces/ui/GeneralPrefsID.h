...
DECLARE_PMID(kWidgetIDSpace, kPostPasteNudgeIconWidgetID, kGeneralPrefsDialogPrefix + 62)
DECLARE_PMID(kWidgetIDSpace, kShowAutoStyleNudgeWidgetID, kGeneralPrefsDialogPrefix + 63)
...
DECLARE_PMID(kWidgetIDSpace, kResetPrefsDialogButtonWidgetID,		kGeneralPrefsDialogPrefix + 114)
DECLARE_PMID(kWidgetIDSpace, kResetPrefsIAMWidgetID,		kGeneralPrefsDialogPrefix + 115)
