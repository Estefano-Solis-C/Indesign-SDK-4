...
class IClipboardController : public CDataExchangeController
{
	...
	public:
		...
		*/
        ...
        /** Get is the data on clipboard from external source or and internal copy from InDesign
                ...
                @return kTrue if external content
        */
        
        virtual bool16  IsClipboardExternal()const = 0;

         /** Set isClipboardExternal flag to false whenever copy is initiated from InDesign
	...
	public:
		...
		*/
		...
		/** Returns the name of source app for current clipboard content
			Implementation is done on Win only. 		
		*/
