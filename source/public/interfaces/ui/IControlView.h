...
public:
	...
	*/
    ...
    /** This function should be used only for Icon Widgets.
        Sets the resource ID for the widget and the theme to use for the icon.
        @param id resource ID to associate with this widget.
        @param isDarkIcon whether the icon should be dark or bright.
    */
