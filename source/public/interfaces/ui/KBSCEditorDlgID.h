...
DECLARE_PMID(kClassIDSpace, kKBSCAiPsRollOverIconWidgetBoss,	kKBSCEditorDlgPrefix + 21)
...
DECLARE_PMID(kWidgetIDSpace, kKBSCPsIconWidgetID, kKBSCEditorDlgPrefix + 29)
DECLARE_PMID(kWidgetIDSpace, kKBSCAiIconWidgetID, kKBSCEditorDlgPrefix + 30)
DECLARE_PMID(kWidgetIDSpace, kPsAiIconPanelWidgetID,		kKBSCEditorDlgPrefix + 31)
