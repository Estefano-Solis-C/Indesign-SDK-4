...
DECLARE_PMID(kClassIDSpace, kEBookExportConversionProvider2Boss,		kEBookExportPrefix + 39)
...
DECLARE_PMID(kInterfaceIDSpace, IID_ILASTMILESEARCHTEXTBOUNDS,		kEBookExportPrefix + 41)
DECLARE_PMID(kInterfaceIDSpace, IID_ILASTMILESEARCHTEXTENABLED,		kEBookExportPrefix + 42)

DECLARE_PMID(kInterfaceIDSpace, IID_IEPUBEXPORTPREFS_3,				kEBookExportPrefix + 43)
DECLARE_PMID(kInterfaceIDSpace, IID_IEPUBEXPORTFXLPREFS_3,			kEBookExportPrefix + 44)

DECLARE_PMID(kInterfaceIDSpace, IID_IEPUBEXPORTPREFS_4,				kEBookExportPrefix + 45)
DECLARE_PMID(kInterfaceIDSpace, IID_IEPUBEXPORTFXLPREFS_4,			kEBookExportPrefix + 46)
...
DECLARE_PMID(kImplementationIDSpace, kLastmileSearchTextBoundsImpl,		kEBookExportPrefix + 63)
DECLARE_PMID(kImplementationIDSpace, kLastMileSearchTextEnabledImpl,		kEBookExportPrefix + 64)
DECLARE_PMID(kImplementationIDSpace, kEPubExportPrefs_3Impl,				kEBookExportPrefix + 65)
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLPrefs_3Impl,				kEBookExportPrefix + 66)
DECLARE_PMID(kImplementationIDSpace, kEBookCodeConversionProviderImpl,	    kEBookExportPrefix + 67)
DECLARE_PMID(kImplementationIDSpace, kEPubExportPrefs_4Impl,				kEBookExportPrefix + 68)
DECLARE_PMID(kImplementationIDSpace, kEPubExportFXLPrefs_4Impl,				kEBookExportPrefix + 69)
...
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityFeatureScriptElement,            kEBookExportPrefix + 112)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityHazardScriptElement,			    kEBookExportPrefix + 113)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityModeScriptElement,	            kEBookExportPrefix + 114)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityModeSufficientScriptElement,		kEBookExportPrefix + 115)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilitySummaryScriptElement,			kEBookExportPrefix + 116)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityConformsToScriptElement,			kEBookExportPrefix + 117)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityCertifiedByScriptElement,		kEBookExportPrefix + 118)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityCredentialsScriptElement,		kEBookExportPrefix + 119)
DECLARE_PMID(kScriptInfoIDSpace, kEPubAccessibilityReportLinkScriptElement,		    kEBookExportPrefix + 120)
DECLARE_PMID(kScriptInfoIDSpace, kEPubCreatePageNavigationScriptElement,            kEBookExportPrefix + 121)	
