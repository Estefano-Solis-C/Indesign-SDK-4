...
public:
	...
	virtual PMString GetMeasurementId() const =0;

	// Adobe internal use only
	virtual void SetMeasurementId(const PMString& measurementId) =0;

	// Adobe internal use only
	virtual bool16 GetShowCookieConsentBanner() const =0;

	// Adobe internal use only
	virtual void SetShowCookieConsentBanner(bool16 showCookieConsentBanner) =0;

	// Adobe internal use only
	virtual PMString GetCookieConsentBannerText() const =0;

	// Adobe internal use only
	virtual void SetCookieConsentBannerText(const PMString& cookieConsentBannerText) =0;
