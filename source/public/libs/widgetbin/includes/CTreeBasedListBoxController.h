...
public:
	...
	virtual void				GetCheckedItems(K2Vector<int32>& checkedItems) const;
	virtual void				SetCheckedItems( const K2Vector<int32>& vecIndices, bool16 bInvalidate = kTrue, bool16 bNotify = kTrue);
