...
void AbstractControlView::SetRsrcID(const RsrcID &id, const bool isDarkIcon)
{
    // We don't use this method in the base class. It will have same functionality as SetRsrcID. We use it only in case of Icons
    SetRsrcID(id);
}
